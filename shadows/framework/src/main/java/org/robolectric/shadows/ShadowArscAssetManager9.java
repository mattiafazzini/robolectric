...
@Implements(value = AssetManager.class, minSdk = Build.VERSION_CODES.P, shadowPicker = ShadowAssetManager.Picker.class)
public class ShadowArscAssetManager9 extends ShadowAssetManager.ArscBase {
    ...
    protected static void createSystemAssetsInZygoteLocked() {
        System.out.println("ShadowArscAssetManager9#createSystemAssetsInZygoteLocked");
        ...
        if (systemCppAssetManager2 == null) {
            ...
            cachedSystemApkAssets = ReflectionHelpers.getStaticField(AssetManager.class, "sSystemApkAssets");
            cachedSystemApkAssetsSet = ReflectionHelpers.getStaticField(AssetManager.class, "sSystemApkAssetsSet");
        } else {
            // reuse the shared system CppAssetManager2; create a new AssetManager around it.
            ReflectionHelpers.setStaticField(AssetManager.class, "sSystemApkAssets", cachedSystemApkAssets);
            ReflectionHelpers.setStaticField(AssetManager.class, "sSystemApkAssetsSet", cachedSystemApkAssetsSet);
            sSystem = ReflectionHelpers.callConstructor(AssetManager.class, ClassParameter.from(boolean.class, true));
    ...
    protected static void nativeVerifySystemIdmaps() {
        System.out.println("ShadowArscAssetManager9#nativeVerifySystemIdmaps");
        return;
    }

    static int CopyValue(/*JNIEnv* env,*/
    ApkAssetsCookie cookie, Res_value value, int ref, int type_spec_flags, ResTable_config config, TypedValue out_typed_value) {
    ...
    static CppAssetManager2 AssetManagerForJavaObject(/* JNIEnv* env,*/
    AssetManager jassetmanager) {
    ...
    Asset asset, long[] out_offsets) throws FileNotFoundException {
        ...
        // reinterpret_cast<long*>(env.GetPrimitiveArrayCritical(out_offsets, 0));
    ...
    protected void __constructor__(boolean sentinel) {
        System.out.println("ShadowArscAssetManager9#__constructor__");
        inNonSystemConstructor = true;
        try {
            // call real constructor so field initialization happens.
            invokeConstructor(AssetManager.class, realAssetManager, ClassParameter.from(boolean.class, sentinel));
        } finally {
    ...
    protected static int getGlobalAssetCount() {
        System.out.println("ShadowArscAssetManager9#getGlobalAssetCount");
    ...
    protected static String getAssetAllocations() {
        System.out.println("ShadowArscAssetManager9#getAssetAllocations");
    ...
    protected static int getGlobalAssetManagerCount() {
        System.out.println("ShadowArscAssetManager9#getGlobalAssetManagerCount");
    ...
    protected static long nativeCreate() {
        System.out.println("ShadowArscAssetManager9#nativeCreate");
    ...
    protected static void nativeDestroy(long ptr) {
        System.out.println("ShadowArscAssetManager9#nativeDestroy");
    ...
    protected static void nativeSetApkAssets(long ptr, @NonNull android.content.res.ApkAssets[] apk_assets_array, boolean invalidate_caches) {
        System.out.println("ShadowArscAssetManager9#nativeSetApkAssets");
        ...
        for (int i = 0; i < apk_assets_len; i++) {
            // env.GetObjectArrayElement(apk_assets_array, i);
            android.content.res.ApkAssets apkAssets = apk_assets_array[i];
            if (apkAssets == null) {
    ...
    protected static void nativeSetConfiguration(long ptr, int mcc, int mnc, @Nullable String locale, int orientation, int touchscreen, int density, int keyboard, int keyboard_hidden, int navigation, int screen_width, int screen_height, int smallest_screen_width_dp, int screen_width_dp, int screen_height_dp, int screen_layout, int ui_mode, int color_mode, int major_version) {
        System.out.println("ShadowArscAssetManager9#nativeSetConfiguration");
    ...
    protected static SparseArray<String> nativeGetAssignedPackageIdentifiers(long ptr) {
        System.out.println("ShadowArscAssetManager9#nativeGetAssignedPackageIdentifiers");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    protected static String[] nativeList(long ptr, @NonNull String path) throws IOException {
        System.out.println("ShadowArscAssetManager9#nativeList");
    ...
    protected static long nativeOpenAsset(long ptr, @NonNull String asset_path, int access_mode) throws FileNotFoundException {
        System.out.println("ShadowArscAssetManager9#nativeOpenAsset");
    ...
    protected static ParcelFileDescriptor nativeOpenAssetFd(long ptr, @NonNull String asset_path, long[] out_offsets) throws IOException {
        System.out.println("ShadowArscAssetManager9#nativeOpenAssetFd");
        String asset_path_utf8 = asset_path;
        if (asset_path_utf8 == null) {
            // This will throw NPE.
            return null;
    ...
    protected static long nativeOpenNonAsset(long ptr, int jcookie, @NonNull String asset_path, int access_mode) throws FileNotFoundException {
        System.out.println("ShadowArscAssetManager9#nativeOpenNonAsset");
    ...
    protected static ParcelFileDescriptor nativeOpenNonAssetFd(long ptr, int jcookie, @NonNull String asset_path, @NonNull long[] out_offsets) throws IOException {
        System.out.println("ShadowArscAssetManager9#nativeOpenNonAssetFd");
        ApkAssetsCookie cookie = JavaCookieToApkAssetsCookie(jcookie);
        String asset_path_utf8 = asset_path;
        if (asset_path_utf8 == null) {
            // This will throw NPE.
    ...
    protected static long nativeOpenXmlAsset(long ptr, int jcookie, @NonNull String asset_path) throws FileNotFoundException {
        System.out.println("ShadowArscAssetManager9#nativeOpenXmlAsset");
        ApkAssetsCookie cookie = JavaCookieToApkAssetsCookie(jcookie);
        String asset_path_utf8 = asset_path;
        if (asset_path_utf8 == null) {
            // This will throw NPE.
    ...
    protected static int nativeGetResourceValue(long ptr, @AnyRes int resid, short density, @NonNull TypedValue typed_value, boolean resolve_references) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceValue");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    protected static int nativeGetResourceBagValue(long ptr, @AnyRes int resid, int bag_entry_id, @NonNull TypedValue typed_value) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceBagValue");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    protected static int[] nativeGetStyleAttributes(long ptr, @StyleRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetStyleAttributes");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ResolvedBag bag = assetmanager.GetBag(resid);
        if (bag == null) {
            return null;
    ...
    protected static String[] nativeGetResourceStringArray(long ptr, @ArrayRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceStringArray");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ResolvedBag bag = assetmanager.GetBag(resid);
        if (bag == null) {
            return null;
    ...
    protected static int[] nativeGetResourceStringArrayInfo(long ptr, @ArrayRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceStringArrayInfo");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ResolvedBag bag = assetmanager.GetBag(resid);
        if (bag == null) {
            return null;
    ...
    protected static int[] nativeGetResourceIntArray(long ptr, @ArrayRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceIntArray");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ResolvedBag bag = assetmanager.GetBag(resid);
        if (bag == null) {
            return null;
    ...
    protected static int nativeGetResourceArraySize(long ptr, @ArrayRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceArraySize");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ResolvedBag bag = assetmanager.GetBag(resid);
        if (bag == null) {
            return -1;
    ...
    protected static int nativeGetResourceArray(long ptr, @ArrayRes int resid, @NonNull int[] out_data) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceArray");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ResolvedBag bag = assetmanager.GetBag(resid);
        if (bag == null) {
            return -1;
        ...
        // reinterpret_cast<int*>(env.GetPrimitiveArrayCritical(out_data, null));
        int[] buffer = out_data;
        if (buffer == null) {
            return -1;
        }
    ...
    protected static int nativeGetResourceIdentifier(long ptr, @NonNull String name, @Nullable String def_type, @Nullable String def_package) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceIdentifier");
    ...
    protected static String nativeGetResourceName(long ptr, @AnyRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceName");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    protected static String nativeGetResourcePackageName(long ptr, @AnyRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourcePackageName");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    protected static String nativeGetResourceTypeName(long ptr, @AnyRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceTypeName");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        final ResourceName name = new ResourceName();
        if (!assetmanager.GetResourceName(resid, name)) {
            return null;
    ...
    protected static String nativeGetResourceEntryName(long ptr, @AnyRes int resid) {
        System.out.println("ShadowArscAssetManager9#nativeGetResourceEntryName");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        final ResourceName name = new ResourceName();
        if (!assetmanager.GetResourceName(resid, name)) {
            return null;
    ...
    protected static String[] nativeGetLocales(long ptr, boolean exclude_system) {
        System.out.println("ShadowArscAssetManager9#nativeGetLocales");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        Set<String> locales = assetmanager.GetResourceLocales(exclude_system, true);
        // env.NewObjectArray(locales.size(), g_stringClass, null);
    ...
    static Configuration ConstructConfigurationObject(/* JNIEnv* env,*/
    ...
    protected static Configuration[] nativeGetSizeConfigurations(long ptr) {
        System.out.println("ShadowArscAssetManager9#nativeGetSizeConfigurations");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    @Implementation(minSdk = P)
    protected static void nativeApplyStyle(long ptr, long theme_ptr, @AttrRes int def_style_attr, @StyleRes int def_style_resid, long xml_parser_ptr, @NonNull int[] java_attrs, long out_values_ptr, long out_indices_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeApplyStyle");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        ...
        // reinterpret_cast<int*>(env.GetPrimitiveArrayCritical(java_attrs, null));
    ...
    protected static boolean nativeResolveAttrs(long ptr, long theme_ptr, @AttrRes int def_style_attr, @StyleRes int def_style_resid, @Nullable int[] java_values, @NonNull int[] java_attrs, @NonNull int[] out_java_values, @NonNull int[] out_java_indices) {
        System.out.println("ShadowArscAssetManager9#nativeResolveAttrs");
        int attrs_len = java_attrs.length;
        ...
        if (java_values != null) {
            ...
            // reinterpret_cast<int*>(env.GetPrimitiveArrayCritical(java_values, null));
            values = java_values;
            if (values == null) {
    ...
    protected static boolean nativeRetrieveAttributes(long ptr, long xml_parser_ptr, @NonNull int[] java_attrs, @NonNull int[] out_java_values, @NonNull int[] out_java_indices) {
        System.out.println("ShadowArscAssetManager9#nativeRetrieveAttributes");
        int attrs_len = java_attrs.length;
        int out_values_len = out_java_values.length;
        if (out_values_len < (attrs_len * STYLE_NUM_ENTRIES)) {
            throw new IndexOutOfBoundsException("outValues too small");
    ...
    protected static long nativeThemeCreate(long ptr) {
        System.out.println("ShadowArscAssetManager9#nativeThemeCreate");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
    ...
    protected static void nativeThemeDestroy(long theme_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeThemeDestroy");
    ...
    protected static void nativeThemeApplyStyle(long ptr, long theme_ptr, @StyleRes int resid, boolean force) {
        System.out.println("ShadowArscAssetManager9#nativeThemeApplyStyle");
    ...
    protected static void nativeThemeCopy(long dst_theme_ptr, long src_theme_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeThemeCopy");
    ...
    protected static void nativeThemeClear(long themePtr) {
        System.out.println("ShadowArscAssetManager9#nativeThemeClear");
    ...
    protected static int nativeThemeGetAttributeValue(long ptr, long theme_ptr, @AttrRes int resid, @NonNull TypedValue typed_value, boolean resolve_references) {
        System.out.println("ShadowArscAssetManager9#nativeThemeGetAttributeValue");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        Theme theme = Registries.NATIVE_THEME9_REGISTRY.getNativeObject(theme_ptr);
        CHECK(theme.GetAssetManager() == assetmanager);
        final Ref<Res_value> value = new Ref<>(null);
    ...
    protected static void nativeThemeDump(long ptr, long theme_ptr, int priority, String tag, String prefix) {
        System.out.println("ShadowArscAssetManager9#nativeThemeDump");
        CppAssetManager2 assetmanager = AssetManagerFromLong(ptr);
        Theme theme = Registries.NATIVE_THEME9_REGISTRY.getNativeObject(theme_ptr);
        CHECK(theme.GetAssetManager() == assetmanager);
    }
    ...
    protected static int nativeThemeGetChangingConfigurations(long theme_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeThemeGetChangingConfigurations");
        Theme theme = Registries.NATIVE_THEME9_REGISTRY.getNativeObject(theme_ptr);
    ...
    protected static void nativeAssetDestroy(long asset_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeAssetDestroy");
    ...
    protected static int nativeAssetReadChar(long asset_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeAssetReadChar");
    ...
    protected static int nativeAssetRead(long asset_ptr, byte[] java_buffer, int offset, int len) throws IOException {
        System.out.println("ShadowArscAssetManager9#nativeAssetRead");
        if (len == 0) {
            return 0;
        }
    ...
    protected static long nativeAssetSeek(long asset_ptr, long offset, int whence) {
        System.out.println("ShadowArscAssetManager9#nativeAssetSeek");
        Asset asset = Registries.NATIVE_ASSET_REGISTRY.getNativeObject(asset_ptr);
    ...
    protected static long nativeAssetGetLength(long asset_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeAssetGetLength");
        Asset asset = Registries.NATIVE_ASSET_REGISTRY.getNativeObject(asset_ptr);
    ...
    protected static long nativeAssetGetRemainingLength(long asset_ptr) {
        System.out.println("ShadowArscAssetManager9#nativeAssetGetRemainingLength");
        Asset asset = Registries.NATIVE_ASSET_REGISTRY.getNativeObject(asset_ptr);
