...
public class ShadowStatFs {
    ...
    protected void __constructor__(String path) {
        System.out.println("ShadowStatFs#__constructor__");
        restat(path);
    }

    @Implementation
    protected int getBlockSize() {
        System.out.println("ShadowStatFs#getBlockSize");
        return BLOCK_SIZE;
    }

    @Implementation
    protected int getBlockCount() {
        System.out.println("ShadowStatFs#getBlockCount");
        return stat.blockCount;
    }

    @Implementation
    protected int getFreeBlocks() {
        System.out.println("ShadowStatFs#getFreeBlocks");
        return stat.freeBlocks;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected long getFreeBlocksLong() {
        System.out.println("ShadowStatFs#getFreeBlocksLong");
        return stat.freeBlocks;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected long getFreeBytes() {
        System.out.println("ShadowStatFs#getFreeBytes");
        return getBlockSizeLong() * getFreeBlocksLong();
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected long getAvailableBytes() {
        System.out.println("ShadowStatFs#getAvailableBytes");
        return getBlockSizeLong() * getAvailableBlocksLong();
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected long getTotalBytes() {
        System.out.println("ShadowStatFs#getTotalBytes");
        return getBlockSizeLong() * getBlockCountLong();
    }

    @Implementation
    protected int getAvailableBlocks() {
        System.out.println("ShadowStatFs#getAvailableBlocks");
        return stat.availableBlocks;
    }

    @Implementation
    protected void restat(String path) {
        System.out.println("ShadowStatFs#restat");
    ...
    protected long getBlockSizeLong() {
        System.out.println("ShadowStatFs#getBlockSizeLong");
        return BLOCK_SIZE;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected long getBlockCountLong() {
        System.out.println("ShadowStatFs#getBlockCountLong");
        return stat.blockCount;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected long getAvailableBlocksLong() {
        System.out.println("ShadowStatFs#getAvailableBlocksLong");
        return stat.availableBlocks;
    }
