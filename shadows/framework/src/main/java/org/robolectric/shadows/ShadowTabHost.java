...
public class ShadowTabHost extends ShadowViewGroup {
    ...
    protected android.widget.TabHost.TabSpec newTabSpec(java.lang.String tag) {
        System.out.println("ShadowTabHost#newTabSpec");
    ...
    protected void addTab(android.widget.TabHost.TabSpec tabSpec) {
        System.out.println("ShadowTabHost#addTab");
    ...
    protected void setCurrentTab(int index) {
        System.out.println("ShadowTabHost#setCurrentTab");
        currentTab = index;
        if (listener != null) {
    ...
    protected void setCurrentTabByTag(String tag) {
        System.out.println("ShadowTabHost#setCurrentTabByTag");
    ...
    protected int getCurrentTab() {
        System.out.println("ShadowTabHost#getCurrentTab");
        if (currentTab == -1 && tabSpecs.size() > 0)
            currentTab = 0;
        return currentTab;
    }
    ...
    protected String getCurrentTabTag() {
        System.out.println("ShadowTabHost#getCurrentTabTag");
        int i = getCurrentTab();
    ...
    protected void setOnTabChangedListener(android.widget.TabHost.OnTabChangeListener listener) {
        System.out.println("ShadowTabHost#setOnTabChangedListener");
        this.listener = listener;
    }

    @Implementation
    protected View getCurrentView() {
        System.out.println("ShadowTabHost#getCurrentView");
    ...
    protected TabWidget getTabWidget() {
        System.out.println("ShadowTabHost#getTabWidget");
    ...
    public static class ShadowTabSpec {
        ...
        protected String getTag() {
            System.out.println("ShadowTabSpec#getTag");
            return tag;
        }
        ...
        protected TabSpec setIndicator(View view) {
            System.out.println("ShadowTabSpec#setIndicator");
        ...
        protected TabSpec setContent(Intent intent) {
            System.out.println("ShadowTabSpec#setContent");
            this.intent = intent;
            return realObject;
        }
