...
@Implements(value = ApkAssets.class, minSdk = Build.VERSION_CODES.P, shadowPicker = Picker.class, isInAndroidSdk = false)
public class ShadowArscApkAssets9 extends ShadowApkAssets {
    ...
    // 
    // namespace android {
    private static final String FRAMEWORK_APK_PATH = ReflectionHelpers.getStaticField(AssetManager.class, "FRAMEWORK_APK_PATH");
    ...
    private static class Key {
        ...
        public boolean equals(Object o) {
            ...
            Key key = (Key) o;
            return system == key.system && load_as_shared_library == key.load_as_shared_library && overlay == key.overlay && Objects.equals(fd, key.fd) && Objects.equals(path, key.path);
        }
    ...
    protected static ApkAssets loadFromPath(@NonNull String path) throws IOException {
        System.out.println("ShadowArscApkAssets9#loadFromPath");
        return getFromCacheOrLoad(new Key(null, path, false, false, false), () -> directlyOn(ApkAssets.class, "loadFromPath", ClassParameter.from(String.class, path)));
    }
    ...
    protected static ApkAssets loadFromPath(String path, boolean system) throws IOException {
        System.out.println("ShadowArscApkAssets9#loadFromPath");
        System.out.println("Called loadFromPath(" + path + ", " + system + "); mode=" + (RuntimeEnvironment.useLegacyResources() ? "legacy" : "binary") + " sdk=" + RuntimeEnvironment.getApiLevel());
        if (FRAMEWORK_APK_PATH.equals(path)) {
            path = RuntimeEnvironment.getAndroidFrameworkJarPath();
        }
        String finalPath = path;
        return getFromCacheOrLoad(new Key(null, path, system, false, false), () -> directlyOn(ApkAssets.class, "loadFromPath", ClassParameter.from(String.class, finalPath), ClassParameter.from(boolean.class, system)));
    }

    @Implementation
    @NonNull
    protected static ApkAssets loadFromPath(@NonNull String path, boolean system, boolean forceSharedLibrary) throws IOException {
        System.out.println("ShadowArscApkAssets9#loadFromPath");
        return getFromCacheOrLoad(new Key(null, path, system, forceSharedLibrary, false), () -> directlyOn(ApkAssets.class, "loadFromPath", ClassParameter.from(String.class, path), ClassParameter.from(boolean.class, system), ClassParameter.from(boolean.class, forceSharedLibrary)));
    }
    ...
    protected static ApkAssets loadFromFd(FileDescriptor fd, String friendlyName, boolean system, boolean forceSharedLibrary) throws IOException {
        System.out.println("ShadowArscApkAssets9#loadFromFd");
    ...
    @Implementation
    @NonNull
    protected static ApkAssets loadOverlayFromPath(@NonNull String idmapPath, boolean system) throws IOException {
        System.out.println("ShadowArscApkAssets9#loadOverlayFromPath");
    ...
    protected static long nativeLoad(String java_path, boolean system, boolean force_shared_lib, boolean overlay) throws IOException {
        System.out.println("ShadowArscApkAssets9#nativeLoad");
    ...
    protected static long nativeLoadFromFd(FileDescriptor file_descriptor, String friendly_name, boolean system, boolean force_shared_lib) {
        System.out.println("ShadowArscApkAssets9#nativeLoadFromFd");
    ...
    protected static void nativeDestroy(long ptr) {
        System.out.println("ShadowArscApkAssets9#nativeDestroy");
    ...
    protected static String nativeGetAssetPath(long ptr) {
        System.out.println("ShadowArscApkAssets9#nativeGetAssetPath");
    ...
    protected static long nativeGetStringBlock(long ptr) {
        System.out.println("ShadowArscApkAssets9#nativeGetStringBlock");
        CppApkAssets apk_assets = Registries.NATIVE_APK_ASSETS_REGISTRY.getNativeObject(ptr);
    ...
    protected static boolean nativeIsUpToDate(long ptr) {
        System.out.println("ShadowArscApkAssets9#nativeIsUpToDate");
        CppApkAssets apk_assets = Registries.NATIVE_APK_ASSETS_REGISTRY.getNativeObject(ptr);
        // (void)apk_assets;
        return JNI_TRUE;
    }
    ...
    protected static long nativeOpenXml(long ptr, String file_name) throws FileNotFoundException {
        System.out.println("ShadowArscApkAssets9#nativeOpenXml");
