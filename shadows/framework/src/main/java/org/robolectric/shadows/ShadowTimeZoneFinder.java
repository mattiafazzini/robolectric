 ...
 */
@Implements(className = "libcore.util.TimeZoneFinder", minSdk = O, maxSdk = P, isInAndroidSdk = false, looseSignatures = true)
public class ShadowTimeZoneFinder {
    ...
    protected static Object getInstance() {
        System.out.println("ShadowTimeZoneFinder#getInstance");
        try {
            return ReflectionHelpers.callStaticMethod(Class.forName("libcore.util.TimeZoneFinder"), "createInstanceForTests", ClassParameter.from(String.class, readTzlookup()));
