...
public class ShadowCanvas {
    ...
    protected void __constructor__(Bitmap bitmap) {
        System.out.println("ShadowCanvas#__constructor__");
    ...
    protected void setBitmap(Bitmap bitmap) {
        System.out.println("ShadowCanvas#setBitmap");
        targetBitmap = bitmap;
    }

    @Implementation
    protected void drawText(String text, float x, float y, Paint paint) {
        System.out.println("ShadowCanvas#drawText");
    ...
    protected void drawText(CharSequence text, int start, int end, float x, float y, Paint paint) {
        System.out.println("ShadowCanvas#drawText");
        drawnTextEventHistory.add(new TextHistoryEvent(x, y, paint, text.subSequence(start, end).toString()));
    }
    ...
    protected void translate(float x, float y) {
        System.out.println("ShadowCanvas#translate");
        this.translateX = x;
        this.translateY = y;
    }
    ...
    protected void scale(float sx, float sy) {
        System.out.println("ShadowCanvas#scale");
        this.scaleX = sx;
        this.scaleY = sy;
    }
    ...
    protected void drawPath(Path path, Paint paint) {
        System.out.println("ShadowCanvas#drawPath");
    ...
    protected void drawCircle(float cx, float cy, float radius, Paint paint) {
        System.out.println("ShadowCanvas#drawCircle");
    ...
    protected void drawArc(RectF oval, float startAngle, float sweepAngle, boolean useCenter, Paint paint) {
        System.out.println("ShadowCanvas#drawArc");
    ...
    protected void drawRect(float left, float top, float right, float bottom, Paint paint) {
        System.out.println("ShadowCanvas#drawRect");
    ...
    protected void drawLine(float startX, float startY, float stopX, float stopY, Paint paint) {
        System.out.println("ShadowCanvas#drawLine");
    ...
    protected void drawOval(RectF oval, Paint paint) {
        System.out.println("ShadowCanvas#drawOval");
        ovalPaintEvents.add(new OvalPaintHistoryEvent(oval, paint));
    }

    @Implementation
    protected int save() {
        System.out.println("ShadowCanvas#save");
        return 1;
    }
    ...
    protected int getWidth() {
        System.out.println("ShadowCanvas#getWidth");
        return width;
    }

    @Implementation
    protected int getHeight() {
        System.out.println("ShadowCanvas#getHeight");
        return height;
    }
