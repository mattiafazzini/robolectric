...
public class ShadowBluetoothHeadset {
    ...
    protected List<BluetoothDevice> getConnectedDevices() {
        System.out.println("ShadowBluetoothHeadset#getConnectedDevices");
    ...
    protected int getConnectionState(BluetoothDevice device) {
        System.out.println("ShadowBluetoothHeadset#getConnectionState");
        return connectedDevices.contains(device) ? BluetoothProfile.STATE_CONNECTED : BluetoothProfile.STATE_DISCONNECTED;
    }
    ...
    protected boolean sendVendorSpecificResultCode(BluetoothDevice device, String command, String arg) {
        System.out.println("ShadowBluetoothHeadset#sendVendorSpecificResultCode");
        if (command == null) {
