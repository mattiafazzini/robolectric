...
public class ShadowSubscriptionManager {
    ...
    public static final int INVALID_PHONE_INDEX = ReflectionHelpers.getStaticField(SubscriptionManager.class, "INVALID_PHONE_INDEX");
    ...
    protected static int getDefaultSubscriptionId() {
        System.out.println("ShadowSubscriptionManager#getDefaultSubscriptionId");
    ...
    protected static int getDefaultDataSubscriptionId() {
        System.out.println("ShadowSubscriptionManager#getDefaultDataSubscriptionId");
    ...
    protected static int getDefaultSmsSubscriptionId() {
        System.out.println("ShadowSubscriptionManager#getDefaultSmsSubscriptionId");
    ...
    protected static int getDefaultVoiceSubscriptionId() {
        System.out.println("ShadowSubscriptionManager#getDefaultVoiceSubscriptionId");
    ...
    protected static int getDefaultSubId() {
        System.out.println("ShadowSubscriptionManager#getDefaultSubId");
        return defaultSubscriptionId;
    }
    ...
    protected static int getDefaultVoiceSubId() {
        System.out.println("ShadowSubscriptionManager#getDefaultVoiceSubId");
        return defaultVoiceSubscriptionId;
    }
    ...
    protected static int getDefaultSmsSubId() {
        System.out.println("ShadowSubscriptionManager#getDefaultSmsSubId");
        return defaultSmsSubscriptionId;
    }
    ...
    protected static int getDefaultDataSubId() {
        System.out.println("ShadowSubscriptionManager#getDefaultDataSubId");
        return defaultDataSubscriptionId;
    }
    ...
    protected List<SubscriptionInfo> getActiveSubscriptionInfoList() {
        System.out.println("ShadowSubscriptionManager#getActiveSubscriptionInfoList");
    ...
    protected List<SubscriptionInfo> getAvailableSubscriptionInfoList() {
        System.out.println("ShadowSubscriptionManager#getAvailableSubscriptionInfoList");
    ...
    protected int getActiveSubscriptionInfoCount() {
        System.out.println("ShadowSubscriptionManager#getActiveSubscriptionInfoCount");
    ...
    protected SubscriptionInfo getActiveSubscriptionInfo(int subId) {
        System.out.println("ShadowSubscriptionManager#getActiveSubscriptionInfo");
    ...
    protected SubscriptionInfo getActiveSubscriptionInfoForSimSlotIndex(int slotIndex) {
        System.out.println("ShadowSubscriptionManager#getActiveSubscriptionInfoForSimSlotIndex");
        if (subscriptionList == null) {
            return null;
        }
        for (SubscriptionInfo info : subscriptionList) {
    ...
    protected void addOnSubscriptionsChangedListener(OnSubscriptionsChangedListener listener) {
        System.out.println("ShadowSubscriptionManager#addOnSubscriptionsChangedListener");
    ...
    protected void removeOnSubscriptionsChangedListener(OnSubscriptionsChangedListener listener) {
        System.out.println("ShadowSubscriptionManager#removeOnSubscriptionsChangedListener");
    ...
    protected int[] getActiveSubscriptionIdList() {
        System.out.println("ShadowSubscriptionManager#getActiveSubscriptionIdList");
    ...
    protected boolean isNetworkRoaming(int simSubscriptionId) {
        System.out.println("ShadowSubscriptionManager#isNetworkRoaming");
    ...
    protected static int getPhoneId(int subId) {
        System.out.println("ShadowSubscriptionManager#getPhoneId");
    ...
    public static class SubscriptionInfoBuilder {
        ...
        private final SubscriptionInfo subscriptionInfo = ReflectionHelpers.callConstructor(SubscriptionInfo.class);
