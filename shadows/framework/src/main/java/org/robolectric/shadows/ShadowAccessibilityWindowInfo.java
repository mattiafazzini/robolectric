...
public class ShadowAccessibilityWindowInfo {
    ...
    protected static AccessibilityWindowInfo obtain() {
        System.out.println("ShadowAccessibilityWindowInfo#obtain");
    ...
    public boolean equals(Object object) {
        System.out.println("ShadowAccessibilityWindowInfo#equals");
    ...
    @Implementation
    public int hashCode() {
        System.out.println("ShadowAccessibilityWindowInfo#hashCode");
    ...
    protected int getType() {
        System.out.println("ShadowAccessibilityWindowInfo#getType");
        return type;
    }

    @Implementation
    protected int getChildCount() {
        System.out.println("ShadowAccessibilityWindowInfo#getChildCount");
        if (children == null) {
            return 0;
        }
    ...
    protected AccessibilityWindowInfo getChild(int index) {
        System.out.println("ShadowAccessibilityWindowInfo#getChild");
        if (children == null) {
            return null;
        }
    ...
    protected AccessibilityWindowInfo getParent() {
        System.out.println("ShadowAccessibilityWindowInfo#getParent");
        return parent;
    }

    @Implementation
    protected AccessibilityNodeInfo getRoot() {
        System.out.println("ShadowAccessibilityWindowInfo#getRoot");
        return (rootNode == null) ? null : AccessibilityNodeInfo.obtain(rootNode);
    }

    @Implementation
    protected boolean isActive() {
        System.out.println("ShadowAccessibilityWindowInfo#isActive");
        return isActive;
    }

    @Implementation
    protected int getId() {
        System.out.println("ShadowAccessibilityWindowInfo#getId");
        return id;
    }

    @Implementation
    protected void getBoundsInScreen(Rect outBounds) {
        System.out.println("ShadowAccessibilityWindowInfo#getBoundsInScreen");
    ...
    protected int getLayer() {
        System.out.println("ShadowAccessibilityWindowInfo#getLayer");
        return layer;
    }
    ...
    protected CharSequence getTitle() {
        System.out.println("ShadowAccessibilityWindowInfo#getTitle");
        return title;
    }

    @Implementation
    protected boolean isFocused() {
        System.out.println("ShadowAccessibilityWindowInfo#isFocused");
        return isFocused;
    }

    @Implementation
    protected boolean isAccessibilityFocused() {
        System.out.println("ShadowAccessibilityWindowInfo#isAccessibilityFocused");
