...
public class ShadowNetworkInfo {
    ...
    public static NetworkInfo newInstance(NetworkInfo.DetailedState detailedState, int type, int subType, boolean isAvailable, boolean isConnected) {
        return newInstance(detailedState, type, subType, isAvailable, isConnected ? NetworkInfo.State.CONNECTED : NetworkInfo.State.DISCONNECTED);
    }
    ...
    protected boolean isConnected() {
        System.out.println("ShadowNetworkInfo#isConnected");
        return state == NetworkInfo.State.CONNECTED;
    }

    @Implementation
    protected boolean isConnectedOrConnecting() {
        System.out.println("ShadowNetworkInfo#isConnectedOrConnecting");
        return isConnected() || state == NetworkInfo.State.CONNECTING;
    }

    @Implementation
    protected NetworkInfo.State getState() {
        System.out.println("ShadowNetworkInfo#getState");
        return state;
    }

    @Implementation
    protected NetworkInfo.DetailedState getDetailedState() {
        System.out.println("ShadowNetworkInfo#getDetailedState");
        return detailedState;
    }

    @Implementation
    protected int getType() {
        System.out.println("ShadowNetworkInfo#getType");
        return connectionType;
    }

    @Implementation
    protected int getSubtype() {
        System.out.println("ShadowNetworkInfo#getSubtype");
        return connectionSubType;
    }

    @Implementation
    protected boolean isAvailable() {
        System.out.println("ShadowNetworkInfo#isAvailable");
        return isAvailable;
    }
