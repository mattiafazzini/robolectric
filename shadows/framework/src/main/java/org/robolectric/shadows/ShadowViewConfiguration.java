...
public class ShadowViewConfiguration {
    ...
    protected static ViewConfiguration get(Context context) {
        System.out.println("ShadowViewConfiguration#get");
    ...
    protected static int getScrollBarSize() {
        System.out.println("ShadowViewConfiguration#getScrollBarSize");
        return SCROLL_BAR_SIZE;
    }

    @Implementation
    protected int getScaledScrollBarSize() {
        System.out.println("ShadowViewConfiguration#getScaledScrollBarSize");
        return scrollbarSize;
    }

    @Implementation
    protected static int getScrollBarFadeDuration() {
        System.out.println("ShadowViewConfiguration#getScrollBarFadeDuration");
        return SCROLL_BAR_FADE_DURATION;
    }

    @Implementation
    protected static int getScrollDefaultDelay() {
        System.out.println("ShadowViewConfiguration#getScrollDefaultDelay");
        return SCROLL_BAR_DEFAULT_DELAY;
    }

    @Implementation
    protected static int getFadingEdgeLength() {
        System.out.println("ShadowViewConfiguration#getFadingEdgeLength");
        return FADING_EDGE_LENGTH;
    }

    @Implementation
    protected int getScaledFadingEdgeLength() {
        System.out.println("ShadowViewConfiguration#getScaledFadingEdgeLength");
        return fadingEdgeLength;
    }

    @Implementation
    protected static int getPressedStateDuration() {
        System.out.println("ShadowViewConfiguration#getPressedStateDuration");
        return PRESSED_STATE_DURATION;
    }

    @Implementation
    protected static int getLongPressTimeout() {
        System.out.println("ShadowViewConfiguration#getLongPressTimeout");
        return LONG_PRESS_TIMEOUT;
    }

    @Implementation
    protected static int getTapTimeout() {
        System.out.println("ShadowViewConfiguration#getTapTimeout");
        return TAP_TIMEOUT;
    }

    @Implementation
    protected static int getJumpTapTimeout() {
        System.out.println("ShadowViewConfiguration#getJumpTapTimeout");
        return JUMP_TAP_TIMEOUT;
    }

    @Implementation
    protected static int getDoubleTapTimeout() {
        System.out.println("ShadowViewConfiguration#getDoubleTapTimeout");
        return DOUBLE_TAP_TIMEOUT;
    }

    @Implementation
    protected static int getEdgeSlop() {
        System.out.println("ShadowViewConfiguration#getEdgeSlop");
        return EDGE_SLOP;
    }

    @Implementation
    protected int getScaledEdgeSlop() {
        System.out.println("ShadowViewConfiguration#getScaledEdgeSlop");
        return edgeSlop;
    }

    @Implementation
    protected static int getTouchSlop() {
        System.out.println("ShadowViewConfiguration#getTouchSlop");
        return TOUCH_SLOP;
    }

    @Implementation
    protected int getScaledTouchSlop() {
        System.out.println("ShadowViewConfiguration#getScaledTouchSlop");
        return touchSlop;
    }

    @Implementation
    protected int getScaledPagingTouchSlop() {
        System.out.println("ShadowViewConfiguration#getScaledPagingTouchSlop");
        return pagingTouchSlop;
    }

    @Implementation
    protected int getScaledDoubleTapSlop() {
        System.out.println("ShadowViewConfiguration#getScaledDoubleTapSlop");
        return doubleTapSlop;
    }

    @Implementation
    protected static int getWindowTouchSlop() {
        System.out.println("ShadowViewConfiguration#getWindowTouchSlop");
        return WINDOW_TOUCH_SLOP;
    }

    @Implementation
    protected int getScaledWindowTouchSlop() {
        System.out.println("ShadowViewConfiguration#getScaledWindowTouchSlop");
        return windowTouchSlop;
    }

    @Implementation
    protected static int getMinimumFlingVelocity() {
        System.out.println("ShadowViewConfiguration#getMinimumFlingVelocity");
        return MINIMUM_FLING_VELOCITY;
    }

    @Implementation
    protected int getScaledMinimumFlingVelocity() {
        System.out.println("ShadowViewConfiguration#getScaledMinimumFlingVelocity");
        return minimumFlingVelocity;
    }

    @Implementation
    protected static int getMaximumFlingVelocity() {
        System.out.println("ShadowViewConfiguration#getMaximumFlingVelocity");
        return MAXIMUM_FLING_VELOCITY;
    }

    @Implementation
    protected int getScaledMaximumFlingVelocity() {
        System.out.println("ShadowViewConfiguration#getScaledMaximumFlingVelocity");
        return maximumFlingVelocity;
    }

    @Implementation
    protected static int getMaximumDrawingCacheSize() {
        System.out.println("ShadowViewConfiguration#getMaximumDrawingCacheSize");
        return MAXIMUM_DRAWING_CACHE_SIZE;
    }

    @Implementation
    protected static long getZoomControlsTimeout() {
        System.out.println("ShadowViewConfiguration#getZoomControlsTimeout");
        return ZOOM_CONTROLS_TIMEOUT;
    }

    @Implementation
    protected static long getGlobalActionKeyTimeout() {
        System.out.println("ShadowViewConfiguration#getGlobalActionKeyTimeout");
        return GLOBAL_ACTIONS_KEY_TIMEOUT;
    }

    @Implementation
    protected static float getScrollFriction() {
        System.out.println("ShadowViewConfiguration#getScrollFriction");
        return SCROLL_FRICTION;
    }

    @Implementation
    protected boolean hasPermanentMenuKey() {
        System.out.println("ShadowViewConfiguration#hasPermanentMenuKey");
