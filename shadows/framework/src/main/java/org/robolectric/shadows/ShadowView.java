...
public class ShadowView {
    ...
    protected void __constructor__(Context context, AttributeSet attributeSet, int defStyle) {
        System.out.println("ShadowView#__constructor__");
        if (context == null)
    ...
    protected void setLayerType(int layerType, Paint paint) {
        System.out.println("ShadowView#setLayerType");
        this.layerType = layerType;
    }

    @Implementation
    protected void setOnFocusChangeListener(View.OnFocusChangeListener l) {
        System.out.println("ShadowView#setOnFocusChangeListener");
    ...
    protected void setOnClickListener(View.OnClickListener onClickListener) {
        System.out.println("ShadowView#setOnClickListener");
    ...
    protected void setOnLongClickListener(View.OnLongClickListener onLongClickListener) {
        System.out.println("ShadowView#setOnLongClickListener");
    ...
    protected void setOnSystemUiVisibilityChangeListener(View.OnSystemUiVisibilityChangeListener onSystemUiVisibilityChangeListener) {
        System.out.println("ShadowView#setOnSystemUiVisibilityChangeListener");
    ...
    protected void setOnCreateContextMenuListener(View.OnCreateContextMenuListener onCreateContextMenuListener) {
        System.out.println("ShadowView#setOnCreateContextMenuListener");
    ...
    protected void draw(android.graphics.Canvas canvas) {
        System.out.println("ShadowView#draw");
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        System.out.println("ShadowView#onLayout");
        onLayoutWasCalled = true;
        directlyOn(realView, View.class, "onLayout", ClassParameter.from(boolean.class, changed), ClassParameter.from(int.class, left), ClassParameter.from(int.class, top), ClassParameter.from(int.class, right), ClassParameter.from(int.class, bottom));
    }
    ...
    protected void requestLayout() {
        System.out.println("ShadowView#requestLayout");
    ...
    protected void invalidate() {
        System.out.println("ShadowView#invalidate");
        wasInvalidated = true;
        directly().invalidate();
    }
    ...
    protected boolean onTouchEvent(MotionEvent event) {
        System.out.println("ShadowView#onTouchEvent");
    ...
    protected void setOnTouchListener(View.OnTouchListener onTouchListener) {
        System.out.println("ShadowView#setOnTouchListener");
    ...
    protected boolean post(Runnable action) {
        System.out.println("ShadowView#post");
    ...
    protected boolean postDelayed(Runnable action, long delayMills) {
        System.out.println("ShadowView#postDelayed");
        if (ShadowLooper.looperMode() == LooperMode.Mode.PAUSED) {
    ...
    protected void postInvalidateDelayed(long delayMilliseconds) {
        System.out.println("ShadowView#postInvalidateDelayed");
        if (ShadowLooper.looperMode() == LooperMode.Mode.PAUSED) {
    ...
    protected boolean removeCallbacks(Runnable callback) {
        System.out.println("ShadowView#removeCallbacks");
        if (ShadowLooper.looperMode() == LooperMode.Mode.PAUSED) {
    ...
    protected void scrollTo(int x, int y) {
        System.out.println("ShadowView#scrollTo");
        try {
    ...
    private class AnimationRunner implements Runnable {
        ...
        public void run() {
            ...
            // standard situations.
            if ((animation.getStartTime() == startTime && animation.getStartOffset() == startOffset) && animation.getTransformation(startTime == Animation.START_ON_FIRST_FRAME ? SystemClock.uptimeMillis() : (startTime + startOffset + elapsedTime), new Transformation()) && // We can't handle infinitely repeating animations in the current scheduling model,
    ...
    protected boolean isAttachedToWindow() {
        System.out.println("ShadowView#isAttachedToWindow");
    ...
    protected boolean getGlobalVisibleRect(Rect rect, Point globalOffset) {
        System.out.println("ShadowView#getGlobalVisibleRect");
    ...
    protected void getWindowVisibleDisplayFrame(Rect outRect) {
        System.out.println("ShadowView#getWindowVisibleDisplayFrame");
        ShadowDisplay.getDefaultDisplay().getRectSize(outRect);
    }

    @Implementation(minSdk = N)
    protected void getWindowDisplayFrame(Rect outRect) {
        System.out.println("ShadowView#getWindowDisplayFrame");
        ShadowDisplay.getDefaultDisplay().getRectSize(outRect);
    }
