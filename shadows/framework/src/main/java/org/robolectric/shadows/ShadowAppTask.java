...
public class ShadowAppTask {
    ...
    public static AppTask newInstance() {
        return ReflectionHelpers.callConstructor(AppTask.class, ReflectionHelpers.ClassParameter.from(IAppTask.class, null));
    }
    ...
    protected void finishAndRemoveTask() {
        System.out.println("ShadowAppTask#finishAndRemoveTask");
    ...
    protected RecentTaskInfo getTaskInfo() {
        System.out.println("ShadowAppTask#getTaskInfo");
    ...
    protected void moveToFront() {
        System.out.println("ShadowAppTask#moveToFront");
    ...
    protected void startActivity(Context context, Intent intent, Bundle options) {
        System.out.println("ShadowAppTask#startActivity");
    ...
    protected void setExcludeFromRecents(boolean exclude) {
        System.out.println("ShadowAppTask#setExcludeFromRecents");
