...
public class ShadowMediaMuxer {
    ...
    protected void __constructor__(@NonNull String path, @Format int format) throws IOException {
        System.out.println("ShadowMediaMuxer#__constructor__");
        if (path == null) {
        ...
        if (RuntimeEnvironment.getApiLevel() < O) {
            ...
            ReflectionHelpers.callInstanceMethod(MediaMuxer.class, realMuxer, "setUpMediaMuxer", ReflectionHelpers.ClassParameter.from(FileDescriptor.class, fd), ReflectionHelpers.ClassParameter.from(int.class, format));
        }
    }
    ...
    protected static long nativeSetup(@NonNull FileDescriptor fd, int format) throws IOException {
        System.out.println("ShadowMediaMuxer#nativeSetup");
     ...
     */
    @Implementation
    protected static int nativeAddTrack(long nativeObject, @NonNull String[] keys, @NonNull Object[] values) {
        System.out.println("ShadowMediaMuxer#nativeAddTrack");
     ...
     */
    @Implementation
    protected static void nativeWriteSampleData(long nativeObject, int trackIndex, @NonNull ByteBuffer byteBuf, int offset, int size, long presentationTimeUs, @MediaCodec.BufferFlag int flags) {
        System.out.println("ShadowMediaMuxer#nativeWriteSampleData");
    ...
    protected static void nativeStop(long nativeObject) {
        System.out.println("ShadowMediaMuxer#nativeStop");
        try {
