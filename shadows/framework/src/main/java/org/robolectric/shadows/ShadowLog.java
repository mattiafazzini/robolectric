...
public class ShadowLog {
    ...
    private static final Map<String, Queue<LogItem>> logsByTag = Collections.synchronizedMap(new HashMap<String, Queue<LogItem>>());

    private static final Queue<LogItem> logs = new ConcurrentLinkedQueue<>();

    public static PrintStream stream;

    private static final Map<String, Integer> tagToLevel = Collections.synchronizedMap(new HashMap<String, Integer>());
    ...
    protected static int e(String tag, String msg) {
        System.out.println("ShadowLog#e");
    ...
    protected static int d(String tag, String msg) {
        System.out.println("ShadowLog#d");
    ...
    protected static int i(String tag, String msg) {
        System.out.println("ShadowLog#i");
    ...
    protected static int v(String tag, String msg) {
        System.out.println("ShadowLog#v");
    ...
    protected static int w(String tag, String msg) {
        System.out.println("ShadowLog#w");
    ...
    protected static int wtf(String tag, String msg) {
        System.out.println("ShadowLog#wtf");
    ...
    protected static boolean isLoggable(String tag, int level) {
        System.out.println("ShadowLog#isLoggable");
    ...
    protected static int println_native(int bufID, int priority, String tag, String msg) {
        System.out.println("ShadowLog#println_native");
    ...
    public static class LogItem {
        ...
        public boolean equals(Object o) {
            ...
            return type == log.type && !(msg != null ? !msg.equals(log.msg) : log.msg != null) && !(tag != null ? !tag.equals(log.tag) : log.tag != null) && !(throwable != null ? !throwable.equals(log.throwable) : log.throwable != null);
        }
        ...
        public String toString() {
            return "LogItem{" + "type=" + type + ", tag='" + tag + '\'' + ", msg='" + msg + '\'' + ", throwable=" + throwable + '}';
        }
    }
