...
public class ShadowResources {
    ...
    protected static Resources getSystem() {
        System.out.println("ShadowResources#getSystem");
        if (system == null) {
    ...
    protected TypedArray obtainAttributes(AttributeSet set, int[] attrs) {
        System.out.println("ShadowResources#obtainAttributes");
        if (isLegacyAssetManager()) {
            return legacyShadowOf(realResources.getAssets()).attrsToTypedArray(realResources, set, attrs, 0, 0, 0);
        } else {
    ...
    protected String getQuantityString(int id, int quantity, Object... formatArgs) throws Resources.NotFoundException {
        System.out.println("ShadowResources#getQuantityString");
        if (isLegacyAssetManager()) {
    ...
    protected InputStream openRawResource(int id) throws Resources.NotFoundException {
        System.out.println("ShadowResources#openRawResource");
        if (isLegacyAssetManager()) {
            ShadowLegacyAssetManager shadowAssetManager = legacyShadowOf(realResources.getAssets());
    ...
    protected AssetFileDescriptor openRawResourceFd(int id) throws Resources.NotFoundException {
        System.out.println("ShadowResources#openRawResourceFd");
        if (isLegacyAssetManager()) {
    ...
    protected TypedArray obtainTypedArray(int id) throws Resources.NotFoundException {
        System.out.println("ShadowResources#obtainTypedArray");
        if (isLegacyAssetManager()) {
            ShadowLegacyAssetManager shadowAssetManager = legacyShadowOf(realResources.getAssets());
    ...
    protected XmlResourceParser loadXmlResourceParser(int resId, String type) throws Resources.NotFoundException {
        System.out.println("ShadowResources#loadXmlResourceParser");
        if (isLegacyAssetManager()) {
            ShadowLegacyAssetManager shadowAssetManager = legacyShadowOf(realResources.getAssets());
            return shadowAssetManager.loadXmlResourceParser(resId, type);
        } else {
            return directlyOn(realResources, Resources.class, "loadXmlResourceParser", ClassParameter.from(int.class, resId), ClassParameter.from(String.class, type));
        }
    }
    ...
    protected XmlResourceParser loadXmlResourceParser(String file, int id, int assetCookie, String type) throws Resources.NotFoundException {
        ...
        if (isLegacyAssetManager()) {
            ...
            return directlyOn(realResources, Resources.class, "loadXmlResourceParser", ClassParameter.from(String.class, file), ClassParameter.from(int.class, id), ClassParameter.from(int.class, assetCookie), ClassParameter.from(String.class, type));
        }
    }
    ...
    protected Drawable loadDrawable(TypedValue value, int id) {
        System.out.println("ShadowResources#loadDrawable");
    ...
    public static class ShadowLegacyTheme extends ShadowTheme {
        ...
        protected TypedArray obtainStyledAttributes(int[] attrs) {
            System.out.println("ShadowLegacyTheme#obtainStyledAttributes");
    ...
    public static class ShadowNotFoundException {
        ...
        protected void __constructor__(String name) {
            System.out.println("ShadowNotFoundException#__constructor__");
            this.message = name;
        }
        ...
        public String toString() {
            System.out.println("ShadowNotFoundException#toString");
