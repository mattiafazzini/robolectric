...
public class ShadowLooper {
    ...
    protected void __constructor__(boolean quitAllowed) {
        System.out.println("ShadowLooper#__constructor__");
    ...
    protected static Looper myLooper() {
        System.out.println("ShadowLooper#myLooper");
        return getLooperForThread(Thread.currentThread());
    }

    @Implementation
    protected static void loop() {
        System.out.println("ShadowLooper#loop");
    ...
    @Implementation
    protected void quit() {
        System.out.println("ShadowLooper#quit");
        if (realObject == Looper.getMainLooper())
    ...
    protected void quitSafely() {
        System.out.println("ShadowLooper#quitSafely");
        quit();
    }
