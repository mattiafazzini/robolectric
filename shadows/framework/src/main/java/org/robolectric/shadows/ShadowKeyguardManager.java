...
public class ShadowKeyguardManager {
    ...
    private static KeyguardManager.KeyguardLock keyguardLock = Shadow.newInstanceOf(KeyguardManager.KeyguardLock.class);
    ...
    protected boolean inKeyguardRestrictedInputMode() {
        System.out.println("ShadowKeyguardManager#inKeyguardRestrictedInputMode");
    ...
    protected void requestDismissKeyguard(Activity activity, KeyguardManager.KeyguardDismissCallback callback) {
        System.out.println("ShadowKeyguardManager#requestDismissKeyguard");
        if (isKeyguardLocked) {
    ...
    protected boolean isKeyguardLocked() {
        System.out.println("ShadowKeyguardManager#isKeyguardLocked");
    ...
    protected KeyguardManager.KeyguardLock newKeyguardLock(String tag) {
        System.out.println("ShadowKeyguardManager#newKeyguardLock");
        return keyguardLock;
    }
    ...
    protected boolean isKeyguardSecure() {
        System.out.println("ShadowKeyguardManager#isKeyguardSecure");
    ...
    protected boolean isDeviceSecure() {
        System.out.println("ShadowKeyguardManager#isDeviceSecure");
    ...
    protected boolean isDeviceLocked() {
        System.out.println("ShadowKeyguardManager#isDeviceLocked");
    ...
    protected Intent createConfirmFactoryResetCredentialIntent(CharSequence title, CharSequence description, CharSequence alternateButtonLabel) {
        System.out.println("ShadowKeyguardManager#createConfirmFactoryResetCredentialIntent");
    ...
    public static class ShadowKeyguardLock {
        ...
        protected void disableKeyguard() {
            System.out.println("ShadowKeyguardLock#disableKeyguard");
        ...
        protected void reenableKeyguard() {
            System.out.println("ShadowKeyguardLock#reenableKeyguard");
