...
public class ShadowLegacyApkAssets extends ShadowApkAssets {
    ...
    @Implementation
    protected void __constructor__(String path, boolean system, boolean forceSharedLib, boolean overlay) throws IOException {
        System.out.println("ShadowLegacyApkAssets#__constructor__");
    ...
    protected String getAssetPath() {
        System.out.println("ShadowLegacyApkAssets#getAssetPath");
        return assetPath;
    }
}
