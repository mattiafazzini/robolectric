...
public class ShadowAdapterView<T extends Adapter> extends ShadowViewGroup {
    ...
    protected void setOnItemSelectedListener(AdapterView.OnItemSelectedListener itemSelectedListener) {
        System.out.println("ShadowAdapterView#setOnItemSelectedListener");
    ...
    public boolean performItemClick(int position) {
        return realAdapterView.performItemClick(realAdapterView.getChildAt(position), position, realAdapterView.getItemIdAtPosition(position));
    }
