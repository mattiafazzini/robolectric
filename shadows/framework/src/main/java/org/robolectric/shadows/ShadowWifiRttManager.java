...
public class ShadowWifiRttManager {
    ...
    protected void startRanging(RangingRequest request, Executor executor, RangingResultCallback callback) {
        System.out.println("ShadowWifiRttManager#startRanging");
