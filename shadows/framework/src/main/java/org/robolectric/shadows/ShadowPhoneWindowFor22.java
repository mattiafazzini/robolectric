 ...
 */
@Implements(className = "com.android.internal.policy.impl.PhoneWindow", maxSdk = LOLLIPOP_MR1, looseSignatures = true, isInAndroidSdk = false)
public class ShadowPhoneWindowFor22 extends ShadowPhoneWindow {

    @Override
    @Implementation(maxSdk = LOLLIPOP_MR1)
    public void setTitle(CharSequence title) {
        System.out.println("ShadowPhoneWindowFor22#setTitle");
        this.title = title;
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        System.out.println("ShadowPhoneWindowFor22#setBackgroundDrawable");
    ...
    protected int getOptionsPanelGravity() {
        System.out.println("ShadowPhoneWindowFor22#getOptionsPanelGravity");
