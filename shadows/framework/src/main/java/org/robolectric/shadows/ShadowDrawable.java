...
public class ShadowDrawable {
    ...
    protected static Drawable createFromStream(InputStream is, String srcName) {
        System.out.println("ShadowDrawable#createFromStream");
    ...
    protected static Drawable createFromResourceStream(Resources res, TypedValue value, InputStream is, String srcName, BitmapFactory.Options opts) {
        System.out.println("ShadowDrawable#createFromResourceStream");
        if (is == null) {
            return null;
        }
        Rect pad = new Rect();
    ...
    protected static Drawable createFromPath(String pathName) {
        System.out.println("ShadowDrawable#createFromPath");
        BitmapDrawable drawable = new BitmapDrawable(ReflectionHelpers.callConstructor(Bitmap.class));
        ShadowBitmapDrawable shadowBitmapDrawable = Shadow.extract(drawable);
    ...
    protected int getIntrinsicWidth() {
        System.out.println("ShadowDrawable#getIntrinsicWidth");
        return intrinsicWidth;
    }

    @Implementation
    protected int getIntrinsicHeight() {
        System.out.println("ShadowDrawable#getIntrinsicHeight");
    ...
    protected void setAlpha(int alpha) {
        System.out.println("ShadowDrawable#setAlpha");
        this.alpha = alpha;
    ...
    protected void invalidateSelf() {
        System.out.println("ShadowDrawable#invalidateSelf");
        wasInvalidated = true;
    ...
    protected int getAlpha() {
        System.out.println("ShadowDrawable#getAlpha");
        return alpha;
    }
