...
public class ShadowBackupManager {
    ...
    protected void __constructor__(Context context) {
        System.out.println("ShadowBackupManager#__constructor__");
        this.context = context;
        Shadow.invokeConstructor(BackupManager.class, realBackupManager, ClassParameter.from(Context.class, context));
    }
    ...
    protected void setBackupEnabled(boolean isEnabled) {
        System.out.println("ShadowBackupManager#setBackupEnabled");
    ...
    protected boolean isBackupEnabled() {
        System.out.println("ShadowBackupManager#isBackupEnabled");
    ...
    protected RestoreSession beginRestoreSession() {
        System.out.println("ShadowBackupManager#beginRestoreSession");
        enforceBackupPermission("beginRestoreSession");
        return ReflectionHelpers.callConstructor(RestoreSession.class, ClassParameter.from(Context.class, context), ClassParameter.from(IRestoreSession.class, new FakeRestoreSession()));
    }
    ...
    private void enforceBackupPermission(String message) {
        RuntimeEnvironment.application.enforceCallingOrSelfPermission(android.Manifest.permission.BACKUP, message);
    }
