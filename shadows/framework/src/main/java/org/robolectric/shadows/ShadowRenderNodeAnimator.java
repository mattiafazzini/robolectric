...
public class ShadowRenderNodeAnimator {
    ...
    public void moveToRunningState() {
        System.out.println("ShadowRenderNodeAnimator#moveToRunningState");
    ...
    @Implementation
    public void doStart() {
        System.out.println("ShadowRenderNodeAnimator#doStart");
    ...
    @Implementation
    public void cancel() {
        System.out.println("ShadowRenderNodeAnimator#cancel");
    ...
    @Implementation
    public void end() {
        System.out.println("ShadowRenderNodeAnimator#end");
