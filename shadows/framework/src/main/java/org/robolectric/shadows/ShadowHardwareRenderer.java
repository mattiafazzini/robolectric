...
@Implements(value = HardwareRenderer.class, isInAndroidSdk = false, looseSignatures = true, minSdk = Q)
public class ShadowHardwareRenderer {
    ...
    protected static long nCreateProxy(boolean translucent, long rootRenderNode) {
        System.out.println("ShadowHardwareRenderer#nCreateProxy");
        return ++nextCreateProxy;
    }

    @Implementation
    protected static Bitmap createHardwareBitmap(/*RenderNode*/
    Object node, /*int*/
    Object width, /*int*/
    Object height) {
        System.out.println("ShadowHardwareRenderer#createHardwareBitmap");
