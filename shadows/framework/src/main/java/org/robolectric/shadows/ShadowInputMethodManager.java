...
public class ShadowInputMethodManager {
    ...
    protected boolean showSoftInput(View view, int flags) {
        System.out.println("ShadowInputMethodManager#showSoftInput");
    ...
    protected boolean hideSoftInputFromWindow(IBinder windowToken, int flags) {
        System.out.println("ShadowInputMethodManager#hideSoftInputFromWindow");
    ...
    protected void toggleSoftInput(int showFlags, int hideFlags) {
        System.out.println("ShadowInputMethodManager#toggleSoftInput");
    ...
    public void setSoftInputVisibilityHandler(SoftInputVisibilityChangeHandler visibilityChangeHandler) {
        this.visibilityChangeHandler = Optional.<SoftInputVisibilityChangeHandler>of(visibilityChangeHandler);
    }
    ...
    protected boolean isActive(View view) {
        System.out.println("ShadowInputMethodManager#isActive");
        return false;
    }
    ...
    protected boolean isFullscreenMode() {
        System.out.println("ShadowInputMethodManager#isFullscreenMode");
        return false;
    }
    ...
    protected static InputMethodManager peekInstance() {
        System.out.println("ShadowInputMethodManager#peekInstance");
