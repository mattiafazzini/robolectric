...
public class ShadowActivityManager {
    ...
    protected int getMemoryClass() {
        System.out.println("ShadowActivityManager#getMemoryClass");
        return memoryClass;
    }

    @Implementation
    protected static boolean isUserAMonkey() {
        System.out.println("ShadowActivityManager#isUserAMonkey");
        return false;
    }
    ...
    protected static int getCurrentUser() {
        System.out.println("ShadowActivityManager#getCurrentUser");
        return UserHandle.myUserId();
    }

    @Implementation
    protected List<ActivityManager.RunningTaskInfo> getRunningTasks(int maxNum) {
        System.out.println("ShadowActivityManager#getRunningTasks");
        return tasks;
    }
    ...
    protected List<ActivityManager.AppTask> getAppTasks() {
        System.out.println("ShadowActivityManager#getAppTasks");
        return appTasks;
    }

    @Implementation
    protected List<ActivityManager.RunningServiceInfo> getRunningServices(int maxNum) {
        System.out.println("ShadowActivityManager#getRunningServices");
        return services;
    }

    @Implementation
    protected List<ActivityManager.RunningAppProcessInfo> getRunningAppProcesses() {
        System.out.println("ShadowActivityManager#getRunningAppProcesses");
    ...
    protected static void getMyMemoryState(ActivityManager.RunningAppProcessInfo inState) {
        System.out.println("ShadowActivityManager#getMyMemoryState");
    ...
    protected boolean switchUser(int userid) {
        System.out.println("ShadowActivityManager#switchUser");
        ShadowUserManager shadowUserManager = Shadow.extract(RuntimeEnvironment.application.getSystemService(Context.USER_SERVICE));
    ...
    protected void killBackgroundProcesses(String packageName) {
        System.out.println("ShadowActivityManager#killBackgroundProcesses");
        backgroundPackage = packageName;
    }

    @Implementation
    protected void getMemoryInfo(ActivityManager.MemoryInfo outInfo) {
        System.out.println("ShadowActivityManager#getMemoryInfo");
        if (memoryInfo != null) {
    ...
    protected android.content.pm.ConfigurationInfo getDeviceConfigurationInfo() {
        System.out.println("ShadowActivityManager#getDeviceConfigurationInfo");
    ...
    protected static IActivityManager getService() {
        System.out.println("ShadowActivityManager#getService");
        return ReflectionHelpers.createNullProxy(IActivityManager.class);
    }

    @Implementation(minSdk = KITKAT)
    protected boolean isLowRamDevice() {
        System.out.println("ShadowActivityManager#isLowRamDevice");
    ...
    protected int getLockTaskModeState() {
        System.out.println("ShadowActivityManager#getLockTaskModeState");
        return lockTaskModeState;
    }

    @Implementation(minSdk = VERSION_CODES.LOLLIPOP)
    protected boolean isInLockTaskMode() {
        System.out.println("ShadowActivityManager#isInLockTaskMode");
    ...
    protected boolean isBackgroundRestricted() {
        System.out.println("ShadowActivityManager#isBackgroundRestricted");
