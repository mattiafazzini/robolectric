...
public class ShadowImageDecoder {
    ...
    private static ImageDecoder jniCreateDecoder(ImgStream imgStream) {
        ...
        return ReflectionHelpers.callConstructor(ImageDecoder.class, ClassParameter.from(long.class, cppImageDecoderPtr), ClassParameter.from(int.class, imgStream.getWidth()), ClassParameter.from(int.class, imgStream.getHeight()), ClassParameter.from(boolean.class, imgStream.isAnimated()), ClassParameter.from(boolean.class, imgStream.isNinePatch()));
    }

    static ImageDecoder ImageDecoder_nCreateFd(FileDescriptor fileDescriptor, Source source) {
    ...
    static ImageDecoder ImageDecoder_nCreateInputStream(InputStream is, byte[] storage, Source source) {
    ...
    static ImageDecoder ImageDecoder_nCreateAsset(long asset_ptr, Source source) throws DecodeException {
    ...
    static ImageDecoder ImageDecoder_nCreateByteBuffer(ByteBuffer jbyteBuffer, int initialPosition, int limit, Source source) throws DecodeException {
    ...
    static ImageDecoder ImageDecoder_nCreateByteArray(byte[] byteArray, int offset, int length, Source source) {
    ...
    private static Bitmap ImageDecoder_nDecodeBitmap(long nativePtr, ImageDecoder decoder, boolean doPostProcess, int width, int height, Rect cropRect, boolean mutable, int allocator, boolean unpremulRequired, boolean conserveMemory, boolean decodeAsAlphaMask, ColorSpace desiredColorSpace) throws IOException {
    ...
    protected static ImageDecoder nCreate(long asset, Source source) throws IOException {
        System.out.println("ShadowImageDecoder#nCreate");
        return ImageDecoder_nCreateAsset(asset, source);
    }

    @Implementation
    protected static ImageDecoder nCreate(ByteBuffer buffer, int position, int limit, Source src) throws IOException {
        System.out.println("ShadowImageDecoder#nCreate");
        return ImageDecoder_nCreateByteBuffer(buffer, position, limit, src);
    }

    @Implementation
    protected static ImageDecoder nCreate(byte[] data, int offset, int length, Source src) throws IOException {
        System.out.println("ShadowImageDecoder#nCreate");
    ...
    @Implementation
    protected static Bitmap nDecodeBitmap(long nativePtr, ImageDecoder decoder, boolean doPostProcess, int width, int height, android.graphics.Rect cropRect, boolean mutable, int allocator, boolean unpremulRequired, boolean conserveMemory, boolean decodeAsAlphaMask, android.graphics.ColorSpace desiredColorSpace) throws IOException {
        System.out.println("ShadowImageDecoder#nDecodeBitmap");
        return ImageDecoder_nDecodeBitmap(nativePtr, decoder, doPostProcess, width, height, cropRect, mutable, allocator, unpremulRequired, conserveMemory, decodeAsAlphaMask, desiredColorSpace);
    }

    @Implementation
    protected static Size nGetSampledSize(long nativePtr, int sampleSize) {
        System.out.println("ShadowImageDecoder#nGetSampledSize");
        return ImageDecoder_nGetSampledSize(nativePtr, sampleSize);
    }

    @Implementation
    protected static void nGetPadding(long nativePtr, Rect outRect) {
        System.out.println("ShadowImageDecoder#nGetPadding");
        ImageDecoder_nGetPadding(nativePtr, outRect);
    }

    @Implementation
    protected static void nClose(long nativePtr) {
        System.out.println("ShadowImageDecoder#nClose");
        ImageDecoder_nClose(nativePtr);
    }

    @Implementation
    protected static String nGetMimeType(long nativePtr) {
        System.out.println("ShadowImageDecoder#nGetMimeType");
        return ImageDecoder_nGetMimeType(nativePtr);
    }

    @Implementation
    protected static ColorSpace nGetColorSpace(long nativePtr) {
        System.out.println("ShadowImageDecoder#nGetColorSpace");
