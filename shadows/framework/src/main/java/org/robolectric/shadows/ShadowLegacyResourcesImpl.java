...
public class ShadowLegacyResourcesImpl extends ShadowResourcesImpl {
    ...
    public String getQuantityString(int id, int quantity, Object... formatArgs) throws Resources.NotFoundException {
        System.out.println("ShadowLegacyResourcesImpl#getQuantityString");
    ...
    public InputStream openRawResource(int id) throws Resources.NotFoundException {
        System.out.println("ShadowLegacyResourcesImpl#openRawResource");
        ShadowLegacyAssetManager shadowAssetManager = legacyShadowOf(realResourcesImpl.getAssets());
    ...
    public AssetFileDescriptor openRawResourceFd(int id) throws Resources.NotFoundException {
        System.out.println("ShadowLegacyResourcesImpl#openRawResourceFd");
    ...
    public XmlResourceParser loadXmlResourceParser(int resId, String type) throws Resources.NotFoundException {
        System.out.println("ShadowLegacyResourcesImpl#loadXmlResourceParser");
        ShadowLegacyAssetManager shadowAssetManager = legacyShadowOf(realResourcesImpl.getAssets());
    ...
    @Implements(value = ResourcesImpl.ThemeImpl.class, minSdk = N, isInAndroidSdk = false, shadowPicker = ShadowResourcesImpl.ShadowThemeImpl.Picker.class)
    public static class ShadowLegacyThemeImpl extends ShadowThemeImpl {
        ...
        public TypedArray obtainStyledAttributes(Resources.Theme wrapper, AttributeSet set, int[] attrs, int defStyleAttr, int defStyleRes) {
            System.out.println("ShadowLegacyThemeImpl#obtainStyledAttributes");
            Resources resources = wrapper.getResources();
            AssetManager assets = resources.getAssets();
            return legacyShadowOf(assets).attrsToTypedArray(resources, set, attrs, defStyleAttr, getNativePtr(), defStyleRes);
        }
    ...
    public Drawable loadDrawable(Resources wrapper, TypedValue value, int id, Resources.Theme theme, boolean useCache) throws Resources.NotFoundException {
        System.out.println("ShadowLegacyResourcesImpl#loadDrawable");
