...
public class ShadowGestureDetector {
    ...
    @Implementation
    protected void __constructor__(Context context, GestureDetector.OnGestureListener listener, Handler handler) {
        System.out.println("ShadowGestureDetector#__constructor__");
        Shadow.invokeConstructor(GestureDetector.class, realObject, from(Context.class, context), from(GestureDetector.OnGestureListener.class, listener), from(Handler.class, handler));
        this.listener = listener;
    }

    @Implementation
    protected boolean onTouchEvent(MotionEvent ev) {
        System.out.println("ShadowGestureDetector#onTouchEvent");
    ...
    protected void setOnDoubleTapListener(OnDoubleTapListener onDoubleTapListener) {
        System.out.println("ShadowGestureDetector#setOnDoubleTapListener");
