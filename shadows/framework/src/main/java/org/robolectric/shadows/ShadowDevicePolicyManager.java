...
public class ShadowDevicePolicyManager {
    ...
    public boolean isDeviceManaged() {
        System.out.println("ShadowDevicePolicyManager#isDeviceManaged");
    ...
    protected String getProfileOwnerNameAsUser(int userId) {
        System.out.println("ShadowDevicePolicyManager#getProfileOwnerNameAsUser");
    ...
    protected int setStorageEncryption(ComponentName admin, boolean encrypt) {
        System.out.println("ShadowDevicePolicyManager#setStorageEncryption");
        enforceActiveAdmin(admin);
    ...
    protected boolean getStorageEncryption(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getStorageEncryption");
    ...
    protected int getPasswordQuality(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordQuality");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumLength(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumLength");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumLetters(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumLetters");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumLowerCase(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumLowerCase");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumUpperCase(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumUpperCase");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumNonLetter(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumNonLetter");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumNumeric(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumNumeric");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected int getPasswordMinimumSymbols(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordMinimumSymbols");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected void setMaximumFailedPasswordsForWipe(ComponentName admin, int num) {
        System.out.println("ShadowDevicePolicyManager#setMaximumFailedPasswordsForWipe");
        enforceActiveAdmin(admin);
    ...
    protected int getMaximumFailedPasswordsForWipe(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getMaximumFailedPasswordsForWipe");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected void setCameraDisabled(ComponentName admin, boolean disabled) {
        System.out.println("ShadowDevicePolicyManager#setCameraDisabled");
        enforceActiveAdmin(admin);
    ...
    protected boolean getCameraDisabled(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getCameraDisabled");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected void setPasswordExpirationTimeout(ComponentName admin, long timeout) {
        System.out.println("ShadowDevicePolicyManager#setPasswordExpirationTimeout");
        enforceActiveAdmin(admin);
    ...
    protected long getPasswordExpirationTimeout(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordExpirationTimeout");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected long getPasswordExpiration(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordExpiration");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected void setMaximumTimeToLock(ComponentName admin, long timeMs) {
        System.out.println("ShadowDevicePolicyManager#setMaximumTimeToLock");
        enforceActiveAdmin(admin);
    ...
    protected long getMaximumTimeToLock(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getMaximumTimeToLock");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected void setPasswordHistoryLength(ComponentName admin, int length) {
        System.out.println("ShadowDevicePolicyManager#setPasswordHistoryLength");
        enforceActiveAdmin(admin);
    ...
    protected int getPasswordHistoryLength(ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getPasswordHistoryLength");
        if (admin != null) {
            enforceActiveAdmin(admin);
        }
    ...
    protected boolean isActivePasswordSufficient() {
        System.out.println("ShadowDevicePolicyManager#isActivePasswordSufficient");
    ...
    protected int getPasswordComplexity() {
        System.out.println("ShadowDevicePolicyManager#getPasswordComplexity");
    ...
    protected void addPersistentPreferredActivity(ComponentName admin, IntentFilter filter, ComponentName activity) {
        ...
        Shadow.<ShadowPackageManager>extract(packageManager).addPersistentPreferredActivity(filter, activity);
    }
    ...
    protected void clearPackagePersistentPreferredActivities(ComponentName admin, String packageName) {
        ...
        enforceDeviceOwnerOrProfileOwner(admin);
        PackageManager packageManager = context.getPackageManager();
        Shadow.<ShadowPackageManager>extract(packageManager).clearPackagePersistentPreferredActivities(packageName);
    }
    ...
    protected boolean hasGrantedPolicy(@NonNull ComponentName admin, int usesPolicy) {
        System.out.println("ShadowDevicePolicyManager#hasGrantedPolicy");
        enforceActiveAdmin(admin);
    ...
    protected void setLockTaskPackages(@NonNull ComponentName admin, String[] packages) {
        System.out.println("ShadowDevicePolicyManager#setLockTaskPackages");
        enforceDeviceOwnerOrProfileOwner(admin);
    ...
    protected String[] getLockTaskPackages(@NonNull ComponentName admin) {
        System.out.println("ShadowDevicePolicyManager#getLockTaskPackages");
        enforceDeviceOwnerOrProfileOwner(admin);
    ...
    protected boolean isLockTaskPermitted(@NonNull String pkg) {
        System.out.println("ShadowDevicePolicyManager#isLockTaskPermitted");
