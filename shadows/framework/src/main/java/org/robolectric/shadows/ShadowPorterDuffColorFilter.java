...
public class ShadowPorterDuffColorFilter {
    ...
    protected void __constructor__(int color, PorterDuff.Mode mode) {
        ...
        this.color = color;
        this.mode = mode;
        Shadow.invokeConstructor(PorterDuffColorFilter.class, realPorterDuffColorFilter, ClassParameter.from(int.class, color), ClassParameter.from(PorterDuff.Mode.class, mode));
    }
