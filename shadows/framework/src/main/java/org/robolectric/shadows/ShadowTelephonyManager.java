...
public class ShadowTelephonyManager {
    ...
    protected void listen(PhoneStateListener listener, int flags) {
        System.out.println("ShadowTelephonyManager#listen");
    ...
    protected int getCallState() {
        System.out.println("ShadowTelephonyManager#getCallState");
        return callState;
    }
    ...
    protected String getDeviceId() {
        System.out.println("ShadowTelephonyManager#getDeviceId");
    ...
    protected String getImei() {
        System.out.println("ShadowTelephonyManager#getImei");
        checkReadPhoneStatePermission();
        return imei;
    }
    ...
    protected String getMeid() {
        System.out.println("ShadowTelephonyManager#getMeid");
        checkReadPhoneStatePermission();
        return meid;
    }
    ...
    protected String getNetworkOperatorName() {
        System.out.println("ShadowTelephonyManager#getNetworkOperatorName");
    ...
    protected String getNetworkCountryIso() {
        System.out.println("ShadowTelephonyManager#getNetworkCountryIso");
    ...
    protected String getNetworkOperator() {
        System.out.println("ShadowTelephonyManager#getNetworkOperator");
        return networkOperator;
    }

    @Implementation
    protected String getSimOperator() {
        System.out.println("ShadowTelephonyManager#getSimOperator");
        return simOperator;
    }
    ...
    protected String getSimOperatorName() {
        System.out.println("ShadowTelephonyManager#getSimOperatorName");
    ...
    protected String getSimSerialNumber() {
        System.out.println("ShadowTelephonyManager#getSimSerialNumber");
        checkReadPhoneStatePermission();
    ...
    protected String getSimCountryIso() {
        System.out.println("ShadowTelephonyManager#getSimCountryIso");
    ...
    protected int getSimState() {
        System.out.println("ShadowTelephonyManager#getSimState");
     ...
     */
    public void setUiccSlotsInfo(/*UiccSlotInfo[]*/
    ...
    @HiddenApi
    protected /*UiccSlotInfo[]*/
    Object getUiccSlotsInfo() {
        System.out.println("ShadowTelephonyManager#getUiccSlotsInfo");
    ...
    protected int getPhoneType() {
        System.out.println("ShadowTelephonyManager#getPhoneType");
        return phoneType;
    }
    ...
    protected String getLine1Number() {
        System.out.println("ShadowTelephonyManager#getLine1Number");
        return line1Number;
    }
    ...
    protected int getNetworkType() {
        System.out.println("ShadowTelephonyManager#getNetworkType");
        return networkType;
    }
    ...
    protected int getVoiceNetworkType() {
        System.out.println("ShadowTelephonyManager#getVoiceNetworkType");
    ...
    protected List<CellInfo> getAllCellInfo() {
        System.out.println("ShadowTelephonyManager#getAllCellInfo");
        return allCellInfo;
    }
    ...
    protected CellLocation getCellLocation() {
        System.out.println("ShadowTelephonyManager#getCellLocation");
    ...
    protected String getGroupIdLevel1() {
        System.out.println("ShadowTelephonyManager#getGroupIdLevel1");
    ...
    private Iterable<PhoneStateListener> getListenersForFlags(int flags) {
        return Iterables.filter(phoneStateRegistrations.keySet(), new Predicate<PhoneStateListener>() {
    ...
    protected boolean isSmsCapable() {
        System.out.println("ShadowTelephonyManager#isSmsCapable");
        return isSmsCapable;
    }
    ...
    protected PersistableBundle getCarrierConfig() {
        System.out.println("ShadowTelephonyManager#getCarrierConfig");
    ...
    protected String getVoiceMailNumber() {
        System.out.println("ShadowTelephonyManager#getVoiceMailNumber");
    ...
    protected String getVoiceMailAlphaTag() {
        System.out.println("ShadowTelephonyManager#getVoiceMailAlphaTag");
    ...
    protected int getPhoneCount() {
        System.out.println("ShadowTelephonyManager#getPhoneCount");
        return phoneCount;
    }
    ...
    protected boolean isVoicemailVibrationEnabled(PhoneAccountHandle handle) {
        System.out.println("ShadowTelephonyManager#isVoicemailVibrationEnabled");
    ...
    protected void setVoicemailVibrationEnabled(PhoneAccountHandle handle, boolean isEnabled) {
        System.out.println("ShadowTelephonyManager#setVoicemailVibrationEnabled");
    ...
    protected Uri getVoicemailRingtoneUri(PhoneAccountHandle handle) {
        System.out.println("ShadowTelephonyManager#getVoicemailRingtoneUri");
    ...
    protected void setVoicemailRingtoneUri(PhoneAccountHandle handle, Uri uri) {
        System.out.println("ShadowTelephonyManager#setVoicemailRingtoneUri");
    ...
    protected TelephonyManager createForPhoneAccountHandle(PhoneAccountHandle handle) {
        System.out.println("ShadowTelephonyManager#createForPhoneAccountHandle");
    ...
    protected TelephonyManager createForSubscriptionId(int subId) {
        System.out.println("ShadowTelephonyManager#createForSubscriptionId");
    ...
    protected ServiceState getServiceState() {
        System.out.println("ShadowTelephonyManager#getServiceState");
        return serviceState;
    }
    ...
    protected boolean isNetworkRoaming() {
        System.out.println("ShadowTelephonyManager#isNetworkRoaming");
    ...
    protected int getCurrentPhoneType(int subId) {
        System.out.println("ShadowTelephonyManager#getCurrentPhoneType");
    ...
    protected List<String> getCarrierPackageNamesForIntentAndPhone(Intent intent, int phoneId) {
        System.out.println("ShadowTelephonyManager#getCarrierPackageNamesForIntentAndPhone");
    ...
    protected List<String> getCarrierPackageNamesForIntent(Intent intent) {
        System.out.println("ShadowTelephonyManager#getCarrierPackageNamesForIntent");
    ...
    protected int getSimCarrierId() {
        System.out.println("ShadowTelephonyManager#getSimCarrierId");
        return simCarrierId;
    }
    ...
    protected String getSubscriberId() {
        System.out.println("ShadowTelephonyManager#getSubscriberId");
        return subscriberId;
    }
    ...
    protected String getVisualVoicemailPackageName() {
        System.out.println("ShadowTelephonyManager#getVisualVoicemailPackageName");
    ...
    protected SignalStrength getSignalStrength() {
        System.out.println("ShadowTelephonyManager#getSignalStrength");
    ...
    public void setSignalStrength(SignalStrength signalStrength) {
        ...
        for (PhoneStateListener listener : getListenersForFlags(PhoneStateListener.LISTEN_SIGNAL_STRENGTHS)) {
    ...
    protected boolean isEmergencyNumber(String number) {
        System.out.println("ShadowTelephonyManager#isEmergencyNumber");
        if (number == null) {
            return false;
        }
    ...
    protected boolean isPotentialEmergencyNumber(String number) {
        System.out.println("ShadowTelephonyManager#isPotentialEmergencyNumber");
    ...
    protected boolean isDataEnabled() {
        System.out.println("ShadowTelephonyManager#isDataEnabled");
        return dataEnabled;
    }
    ...
    protected void setDataEnabled(boolean enabled) {
        System.out.println("ShadowTelephonyManager#setDataEnabled");
        dataEnabled = enabled;
    }
}
