...
public class ShadowBatteryManager {
    ...
    protected boolean isCharging() {
        System.out.println("ShadowBatteryManager#isCharging");
        return isCharging;
    }
    ...
    protected int getIntProperty(int id) {
        System.out.println("ShadowBatteryManager#getIntProperty");
    ...
    protected long getLongProperty(int id) {
        System.out.println("ShadowBatteryManager#getLongProperty");
