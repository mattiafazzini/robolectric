...
public class ShadowMediaMetadataRetriever {
    ...
    protected void setDataSource(String path) {
        System.out.println("ShadowMediaMetadataRetriever#setDataSource");
    ...
    protected String extractMetadata(int keyCode) {
        System.out.println("ShadowMediaMetadataRetriever#extractMetadata");
    ...
    protected Bitmap getFrameAtTime(long timeUs, int option) {
        System.out.println("ShadowMediaMetadataRetriever#getFrameAtTime");
