...
public class ShadowBitmapFactory {
    ...
    protected static Bitmap decodeResourceStream(Resources res, TypedValue value, InputStream is, Rect pad, BitmapFactory.Options opts) {
        System.out.println("ShadowBitmapFactory#decodeResourceStream");
        Bitmap bitmap = directlyOn(BitmapFactory.class, "decodeResourceStream", ClassParameter.from(Resources.class, res), ClassParameter.from(TypedValue.class, value), ClassParameter.from(InputStream.class, is), ClassParameter.from(Rect.class, pad), ClassParameter.from(BitmapFactory.Options.class, opts));
    ...
    protected static Bitmap decodeResource(Resources res, int id, BitmapFactory.Options options) {
        System.out.println("ShadowBitmapFactory#decodeResource");
        if (id == 0) {
            return null;
        }
    ...
    protected static Bitmap decodeFile(String pathName) {
        System.out.println("ShadowBitmapFactory#decodeFile");
    ...
    protected static Bitmap decodeFileDescriptor(FileDescriptor fd, Rect outPadding, BitmapFactory.Options opts) {
        System.out.println("ShadowBitmapFactory#decodeFileDescriptor");
    ...
    protected static Bitmap decodeStream(InputStream is) {
        System.out.println("ShadowBitmapFactory#decodeStream");
    ...
    protected static Bitmap decodeByteArray(byte[] data, int offset, int length) {
        System.out.println("ShadowBitmapFactory#decodeByteArray");
