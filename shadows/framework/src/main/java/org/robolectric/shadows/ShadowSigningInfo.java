...
public class ShadowSigningInfo {
    ...
    protected Signature[] getApkContentsSigners() {
        System.out.println("ShadowSigningInfo#getApkContentsSigners");
        return signatures;
    }
}
