...
public class ShadowParcel {
    ...
    public Parcelable.Creator<?> readParcelableCreator(ClassLoader loader) {
        System.out.println("ShadowParcel#readParcelableCreator");
    ...
    protected void writeByteArray(byte[] b, int offset, int len) {
        System.out.println("ShadowParcel#writeByteArray");
        if (b == null) {
    ...
    public static int nativeDataSize(int nativePtr) {
        System.out.println("ShadowParcel#nativeDataSize");
    ...
    public static int nativeDataAvail(int nativePtr) {
        System.out.println("ShadowParcel#nativeDataAvail");
    ...
    public static int nativeDataPosition(int nativePtr) {
        System.out.println("ShadowParcel#nativeDataPosition");
    ...
    public static int nativeDataCapacity(int nativePtr) {
        System.out.println("ShadowParcel#nativeDataCapacity");
    ...
    public static void nativeSetDataSize(int nativePtr, int size) {
        System.out.println("ShadowParcel#nativeSetDataSize");
    ...
    public static void nativeSetDataPosition(int nativePtr, int pos) {
        System.out.println("ShadowParcel#nativeSetDataPosition");
    ...
    public static void nativeSetDataCapacity(int nativePtr, int size) {
        System.out.println("ShadowParcel#nativeSetDataCapacity");
    ...
    public static void nativeWriteByteArray(int nativePtr, byte[] b, int offset, int len) {
        System.out.println("ShadowParcel#nativeWriteByteArray");
    ...
    protected void writeBlob(byte[] b, int offset, int len) {
        System.out.println("ShadowParcel#writeBlob");
        if (b == null) {
            realObject.writeInt(-1);
            return;
        }
    ...
    protected static void nativeWriteBlob(long nativePtr, byte[] b, int offset, int len) {
        System.out.println("ShadowParcel#nativeWriteBlob");
    ...
    public static void nativeWriteInt(int nativePtr, int val) {
        System.out.println("ShadowParcel#nativeWriteInt");
    ...
    public static void nativeWriteLong(int nativePtr, long val) {
        System.out.println("ShadowParcel#nativeWriteLong");
    ...
    public static void nativeWriteFloat(int nativePtr, float val) {
        System.out.println("ShadowParcel#nativeWriteFloat");
    ...
    public static void nativeWriteDouble(int nativePtr, double val) {
        System.out.println("ShadowParcel#nativeWriteDouble");
    ...
    public static void nativeWriteString(int nativePtr, String val) {
        System.out.println("ShadowParcel#nativeWriteString");
    ...
    protected static void nativeWriteStrongBinder(int nativePtr, IBinder val) {
        System.out.println("ShadowParcel#nativeWriteStrongBinder");
    ...
    public static byte[] nativeCreateByteArray(int nativePtr) {
        System.out.println("ShadowParcel#nativeCreateByteArray");
    ...
    protected static byte[] nativeReadBlob(long nativePtr) {
        System.out.println("ShadowParcel#nativeReadBlob");
    ...
    protected static boolean nativeReadByteArray(long nativePtr, byte[] dest, int destLen) {
        System.out.println("ShadowParcel#nativeReadByteArray");
    ...
    public static int nativeReadInt(int nativePtr) {
        System.out.println("ShadowParcel#nativeReadInt");
    ...
    public static long nativeReadLong(int nativePtr) {
        System.out.println("ShadowParcel#nativeReadLong");
    ...
    public static float nativeReadFloat(int nativePtr) {
        System.out.println("ShadowParcel#nativeReadFloat");
    ...
    public static double nativeReadDouble(int nativePtr) {
        System.out.println("ShadowParcel#nativeReadDouble");
    ...
    public static String nativeReadString(int nativePtr) {
        System.out.println("ShadowParcel#nativeReadString");
    ...
    protected static IBinder nativeReadStrongBinder(int nativePtr) {
        System.out.println("ShadowParcel#nativeReadStrongBinder");
    ...
    synchronized public static Number nativeCreate() {
        System.out.println("ShadowParcel#nativeCreate");
    ...
    public static void nativeFreeBuffer(int nativePtr) {
        System.out.println("ShadowParcel#nativeFreeBuffer");
    ...
    public static void nativeDestroy(int nativePtr) {
        System.out.println("ShadowParcel#nativeDestroy");
    ...
    public static byte[] nativeMarshall(int nativePtr) {
        System.out.println("ShadowParcel#nativeMarshall");
    ...
    public static void nativeUnmarshall(int nativePtr, byte[] data, int offset, int length) {
        System.out.println("ShadowParcel#nativeUnmarshall");
    ...
    public static void nativeAppendFrom(int thisNativePtr, int otherNativePtr, int offset, int length) {
        System.out.println("ShadowParcel#nativeAppendFrom");
    ...
    public static void nativeWriteInterfaceToken(int nativePtr, String interfaceName) {
        System.out.println("ShadowParcel#nativeWriteInterfaceToken");
    ...
    public static void nativeEnforceInterface(int nativePtr, String interfaceName) {
        System.out.println("ShadowParcel#nativeEnforceInterface");
    ...
    static class UnreliableBehaviorError extends AssertionError {
        ...
        UnreliableBehaviorError(Class<?> clazz, int position, ByteBuffer.FakeEncodedItem item, String extraMessage) {
            super(String.format(Locale.US, "Looking for %s at position %d, found %s [%s] taking %d bytes, %s", clazz.getSimpleName(), position, item.value == null ? "null" : item.value.getClass().getSimpleName(), item.value, item.sizeBytes, extraMessage));
        }
    }
    ...
    private static class ByteBuffer {
        ...
        public byte[] createByteArray() {
            ...
            byte[] result = readValue(EMPTY_BYTE_ARRAY, byte[].class, /* allowNull= */
            false);
        ...
        public String readString() {
            ...
            return readValue(null, String.class, /* allowNull= */
            true);
        }
        ...
        public IBinder readStrongBinder() {
            return readValue(null, IBinder.class, /* allowNull= */
            true);
        }
        ...
        private static boolean isEncodedAsAllZeroBytes(Object value) {
            if (value == null) {
                // Nulls are usually encoded as -1.
                return false;
            }
        ...
        private void checkConsistentReadAndIncrementPosition(Class<?> clazz, FakeEncodedItem item) {
            ...
            for (int i = dataPosition; i < endPosition; i++) {
                ...
                if (foundItemItem != item) {
                    throw new UnreliableBehaviorError(clazz, dataPosition, item, String.format(Locale.US, "but [%s] interrupts it at position %d", foundItemItem == null ? "uninitialized data or the end of the buffer" : foundItemItem.value, i));
                }
            }
        ...
        private <T> T readValue(T pastEndValue, Class<T> clazz, boolean allowNull) {
            ...
            if (item == null) {
                ...
                throw new RuntimeException(new UnreliableBehaviorError(clazz, startPosition, item, "and it is non-portable to reinterpret it"));
            }
        }
        ...
        private <T> T readPrimitive(int defaultSizeBytes, T defaultValue, Class<T> clazz) {
            ...
            return readValue(defaultValue, clazz, /* allowNull= */
            false);
        }
    ...
    protected static FileDescriptor openFileDescriptor(String file, int mode) throws IOException {
        System.out.println("ShadowParcel#openFileDescriptor");
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, mode == ParcelFileDescriptor.MODE_READ_ONLY ? "r" : "rw");
