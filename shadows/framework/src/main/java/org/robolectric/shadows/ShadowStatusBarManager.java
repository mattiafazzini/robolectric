...
public class ShadowStatusBarManager {
    ...
    protected void disable(int what) {
        System.out.println("ShadowStatusBarManager#disable");
        disabled = what;
    }

    @Implementation(minSdk = M)
    protected void disable2(int what) {
        System.out.println("ShadowStatusBarManager#disable2");
        disabled2 = what;
    }

    @Implementation(minSdk = Q)
    protected void setDisabledForSetup(boolean disabled) {
        System.out.println("ShadowStatusBarManager#setDisabledForSetup");
        disable(disabled ? StatusBarManager.DEFAULT_SETUP_DISABLE_FLAGS : StatusBarManager.DISABLE_NONE);
        disable2(disabled ? StatusBarManager.DEFAULT_SETUP_DISABLE2_FLAGS : StatusBarManager.DISABLE2_NONE);
    }
