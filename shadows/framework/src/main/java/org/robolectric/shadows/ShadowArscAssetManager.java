...
public class ShadowArscAssetManager extends ShadowAssetManager.ArscBase {
    ...
    protected final String[] list(String path) throws IOException {
        System.out.println("ShadowArscAssetManager#list");
    ...
    final public void setConfiguration(int mcc, int mnc, String locale, int orientation, int touchscreen, int density, int keyboard, int keyboardHidden, int navigation, int screenWidth, int screenHeight, int smallestScreenWidthDp, int screenWidthDp, int screenHeightDp, int screenLayout, int uiMode, int sdkVersion) {
        System.out.println("ShadowArscAssetManager#setConfiguration");
    ...
    protected static void dumpTheme(long theme, int priority, String tag, String prefix) {
        System.out.println("ShadowArscAssetManager#dumpTheme");
        throw new UnsupportedOperationException("not yet implemented");
    }

    @Implementation
    protected String getResourceName(int resid) {
        System.out.println("ShadowArscAssetManager#getResourceName");
        CppAssetManager am = assetManagerForJavaObject();
    ...
    protected String getResourcePackageName(int resid) {
        System.out.println("ShadowArscAssetManager#getResourcePackageName");
    ...
    protected String getResourceTypeName(int resid) {
        System.out.println("ShadowArscAssetManager#getResourceTypeName");
        CppAssetManager cppAssetManager = assetManagerForJavaObject();
        ResourceName name = new ResourceName();
        if (!cppAssetManager.getResources().getResourceName(resid, true, name)) {
            return null;
    ...
    protected String getResourceEntryName(int resid) {
        System.out.println("ShadowArscAssetManager#getResourceEntryName");
        CppAssetManager cppAssetManager = assetManagerForJavaObject();
        ResourceName name = new ResourceName();
        if (!cppAssetManager.getResources().getResourceName(resid, true, name)) {
            return null;
    ...
    public int addAssetPath(String path) {
        System.out.println("ShadowArscAssetManager#addAssetPath");
    ...
    final protected int addAssetPathNative(String path) {
        System.out.println("ShadowArscAssetManager#addAssetPathNative");
    ...
    public int getResourceIdentifier(String name, String defType, String defPackage) {
        System.out.println("ShadowArscAssetManager#getResourceIdentifier");
    ...
    protected final Number openAsset(String fileName, int mode) throws FileNotFoundException {
        System.out.println("ShadowArscAssetManager#openAsset");
        CppAssetManager am = assetManagerForJavaObject();
    ...
    protected ParcelFileDescriptor openAssetFd(String fileName, long[] outOffsets) throws IOException {
        System.out.println("ShadowArscAssetManager#openAssetFd");
        CppAssetManager am = assetManagerForJavaObject();
    ...
    protected final Number openNonAssetNative(int cookie, String fileName, int accessMode) throws FileNotFoundException {
        System.out.println("ShadowArscAssetManager#openNonAssetNative");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
    ...
    protected ParcelFileDescriptor openNonAssetFdNative(int cookie, String fileName, long[] outOffsets) throws IOException {
        System.out.println("ShadowArscAssetManager#openNonAssetFdNative");
        CppAssetManager am = assetManagerForJavaObject();
    ...
    protected final void destroyAsset(int asset) {
        System.out.println("ShadowArscAssetManager#destroyAsset");
    ...
    protected final int readAssetChar(int asset) {
        System.out.println("ShadowArscAssetManager#readAssetChar");
    ...
    protected final int readAsset(int asset, byte[] b, int off, int len) throws IOException {
        System.out.println("ShadowArscAssetManager#readAsset");
    ...
    protected final long seekAsset(int asset, long offset, int whence) {
        System.out.println("ShadowArscAssetManager#seekAsset");
    ...
    protected final long getAssetLength(int asset) {
        System.out.println("ShadowArscAssetManager#getAssetLength");
    ...
    protected final long getAssetRemainingLength(int asset) {
        System.out.println("ShadowArscAssetManager#getAssetRemainingLength");
    ...
    protected int loadResourceValue(int ident, short density, TypedValue outValue, boolean resolve) {
        System.out.println("ShadowArscAssetManager#loadResourceValue");
        if (outValue == null) {
    ...
    private static int copyValue(TypedValue outValue, ResTable table, Res_value value, int ref, int block, int typeSpecFlags) {
        return copyValue(outValue, table, value, ref, block, typeSpecFlags, null);
    }

    private static int copyValue(TypedValue outValue, ResTable table, Res_value value, int ref, int block, int typeSpecFlags, ResTable_config config) {
    ...
    protected final int loadResourceBagValue(int ident, int bagEntryId, TypedValue outValue, boolean resolve) {
        System.out.println("ShadowArscAssetManager#loadResourceBagValue");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return 0;
        }
    ...
    protected static void applyStyle(int themeToken, int defStyleAttr, int defStyleRes, int xmlParserToken, int[] attrs, int[] outValues, int[] outIndices) {
        System.out.println("ShadowArscAssetManager#applyStyle");
    ...
    protected static boolean resolveAttrs(long themeToken, int defStyleAttr, int defStyleRes, int[] inValues, int[] attrs, int[] outValues, int[] outIndices) {
        System.out.println("ShadowArscAssetManager#resolveAttrs");
        if (themeToken == 0) {
    ...
    @HiddenApi
    @Implementation(maxSdk = KITKAT_WATCH)
    protected final boolean retrieveAttributes(int xmlParserToken, int[] attrs, int[] outValues, int[] outIndices) {
        System.out.println("ShadowArscAssetManager#retrieveAttributes");
    ...
    protected int getArraySize(int id) {
        System.out.println("ShadowArscAssetManager#getArraySize");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return 0;
        }
    ...
    protected int retrieveArray(int id, int[] outValues) {
        System.out.println("ShadowArscAssetManager#retrieveArray");
        if (outValues == null) {
            throw new NullPointerException("out values");
        }
        CppAssetManager am = assetManagerForJavaObject();
    ...
    protected Number getNativeStringBlock(int block) {
        System.out.println("ShadowArscAssetManager#getNativeStringBlock");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return RuntimeEnvironment.castNativePtr(0);
        }
    ...
    protected final SparseArray<String> getAssignedPackageIdentifiers() {
        System.out.println("ShadowArscAssetManager#getAssignedPackageIdentifiers");
        CppAssetManager am = assetManagerForJavaObject();
        final ResTable res = am.getResources();
    ...
    protected final Number newTheme() {
        System.out.println("ShadowArscAssetManager#newTheme");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return RuntimeEnvironment.castNativePtr(0);
        }
    ...
    protected final void deleteTheme(int theme) {
        System.out.println("ShadowArscAssetManager#deleteTheme");
    ...
    public static void applyThemeStyle(int themePtr, int styleRes, boolean force) {
        System.out.println("ShadowArscAssetManager#applyThemeStyle");
    ...
    public static void copyTheme(int destPtr, int sourcePtr) {
        System.out.println("ShadowArscAssetManager#copyTheme");
    ...
    protected static int loadThemeAttributeValue(int themeHandle, int ident, TypedValue outValue, boolean resolve) {
        System.out.println("ShadowArscAssetManager#loadThemeAttributeValue");
    ...
    protected final Number openXmlAssetNative(int cookie, String fileName) throws FileNotFoundException {
        System.out.println("ShadowArscAssetManager#openXmlAssetNative");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return RuntimeEnvironment.castNativePtr(0);
        }
    ...
    protected final String[] getArrayStringResource(int arrayResId) {
        System.out.println("ShadowArscAssetManager#getArrayStringResource");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return null;
        }
    ...
    protected final int[] getArrayStringInfo(int arrayResId) {
        System.out.println("ShadowArscAssetManager#getArrayStringInfo");
        CppAssetManager am = assetManagerForJavaObject();
        ResTable res = am.getResources();
        final Ref<bag_entry[]> startOfBag = new Ref<>(null);
        final int N = res.lockBag(arrayResId, startOfBag);
    ...
    public int[] getArrayIntResource(int arrayResId) {
        System.out.println("ShadowArscAssetManager#getArrayIntResource");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return null;
        }
    ...
    protected void init() {
        System.out.println("ShadowArscAssetManager#init");
        // }
        init(false);
    }
    ...
    protected int getStringBlockCount() {
        System.out.println("ShadowArscAssetManager#getStringBlockCount");
        CppAssetManager am = assetManagerForJavaObject();
        if (am == null) {
            return 0;
        }
