...
public class ShadowBluetoothSocket {
    ...
    protected InputStream getInputStream() {
        System.out.println("ShadowBluetoothSocket#getInputStream");
        return inputStream;
    }

    @Implementation
    protected OutputStream getOutputStream() {
        System.out.println("ShadowBluetoothSocket#getOutputStream");
        return outputStream;
    }

    @Implementation
    protected boolean isConnected() {
        System.out.println("ShadowBluetoothSocket#isConnected");
    ...
    protected void connect() throws IOException {
        System.out.println("ShadowBluetoothSocket#connect");
    ...
    protected void close() throws IOException {
        System.out.println("ShadowBluetoothSocket#close");
