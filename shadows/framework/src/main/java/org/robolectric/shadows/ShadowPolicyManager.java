...
public class ShadowPolicyManager {
    ...
    protected static LayoutInflater makeNewLayoutInflater(Context context) {
        System.out.println("ShadowPolicyManager#makeNewLayoutInflater");
        Class<LayoutInflater> phoneLayoutInflaterClass = (Class<LayoutInflater>) ReflectionHelpers.loadClass(ShadowPolicyManager.class.getClassLoader(), "com.android.internal.policy.impl.PhoneLayoutInflater");
