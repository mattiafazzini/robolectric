...
public class ShadowViewGroup extends ShadowView {
    ...
    protected void addView(final View child, final int index, final ViewGroup.LayoutParams params) {
        System.out.println("ShadowViewGroup#addView");
        ShadowLooper shadowLooper = Shadow.extract(Looper.getMainLooper());
        shadowLooper.runPaused(() -> directlyOn(realViewGroup, ViewGroup.class, "addView", ClassParameter.from(View.class, child), ClassParameter.from(int.class, index), ClassParameter.from(ViewGroup.LayoutParams.class, params)));
    }
    ...
    protected void requestDisallowInterceptTouchEvent(boolean disallowIntercept) {
        System.out.println("ShadowViewGroup#requestDisallowInterceptTouchEvent");
    ...
    protected boolean onInterceptTouchEvent(MotionEvent ev) {
        System.out.println("ShadowViewGroup#onInterceptTouchEvent");
