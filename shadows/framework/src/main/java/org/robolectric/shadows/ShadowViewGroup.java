...
public class ShadowViewGroup extends ShadowView {
    ...
    protected void addView(final View child, final int index, final ViewGroup.LayoutParams params) {
        ...
        Runnable addViewRunnable = () -> {
            directlyOn(realViewGroup, ViewGroup.class, "addView", ClassParameter.from(View.class, child), ClassParameter.from(int.class, index), ClassParameter.from(ViewGroup.LayoutParams.class, params));
        };
