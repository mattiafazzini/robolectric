...
public class ShadowDownloadManager {
    ...
    // First request starts at 0 just like in the real DownloadManager
    private long queueCounter = -1;

    private Map<Long, DownloadManager.Request> requestMap = new TreeMap<>();

    @Implementation
    protected long enqueue(DownloadManager.Request request) {
        System.out.println("ShadowDownloadManager#enqueue");
        queueCounter++;
    ...
    protected int remove(long... ids) {
        System.out.println("ShadowDownloadManager#remove");
        int removeCount = 0;
        for (long id : ids) {
    ...
    protected Cursor query(DownloadManager.Query query) {
        System.out.println("ShadowDownloadManager#query");
