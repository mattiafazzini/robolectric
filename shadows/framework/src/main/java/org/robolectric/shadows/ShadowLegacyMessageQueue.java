...
public class ShadowLegacyMessageQueue extends ShadowMessageQueue {
    ...
    public static Number nativeInit() {
        System.out.println("ShadowLegacyMessageQueue#nativeInit");
        return 1;
    }
    ...
    public static void nativeDestroy(int ptr) {
        System.out.println("ShadowLegacyMessageQueue#nativeDestroy");
    ...
    public static boolean nativeIsIdling(int ptr) {
        System.out.println("ShadowLegacyMessageQueue#nativeIsIdling");
    ...
    protected boolean enqueueMessage(final Message msg, long when) {
        System.out.println("ShadowLegacyMessageQueue#enqueueMessage");
    ...
    protected void removeSyncBarrier(int token) {
        System.out.println("ShadowLegacyMessageQueue#removeSyncBarrier");
