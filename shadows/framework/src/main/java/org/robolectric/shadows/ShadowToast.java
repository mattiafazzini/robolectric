...
public class ShadowToast {
    ...
    protected static Toast makeText(Context context, int resId, int duration) {
        System.out.println("ShadowToast#makeText");
    ...
    @Implementation
    protected void show() {
        System.out.println("ShadowToast#show");
    ...
    protected void setText(int resId) {
        System.out.println("ShadowToast#setText");
    ...
    protected void setView(View view) {
        System.out.println("ShadowToast#setView");
        this.view = view;
    }

    @Implementation
    protected View getView() {
        System.out.println("ShadowToast#getView");
        return view;
    }

    @Implementation
    protected void setGravity(int gravity, int xOffset, int yOffset) {
        System.out.println("ShadowToast#setGravity");
    ...
    protected int getGravity() {
        System.out.println("ShadowToast#getGravity");
        return gravity;
    }

    @Implementation
    protected int getXOffset() {
        System.out.println("ShadowToast#getXOffset");
        return xOffset;
    }

    @Implementation
    protected int getYOffset() {
        System.out.println("ShadowToast#getYOffset");
        return yOffset;
    }

    @Implementation
    protected void setDuration(int duration) {
        System.out.println("ShadowToast#setDuration");
        this.duration = duration;
    }

    @Implementation
    protected int getDuration() {
        System.out.println("ShadowToast#getDuration");
        return duration;
    }

    @Implementation
    protected void cancel() {
        System.out.println("ShadowToast#cancel");
        cancelled = true;
    }
