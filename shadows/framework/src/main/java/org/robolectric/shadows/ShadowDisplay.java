...
public class ShadowDisplay {
    ...
    protected void getMetrics(DisplayMetrics outMetrics) {
        System.out.println("ShadowDisplay#getMetrics");
        if (isJB()) {
    ...
    protected void getRealMetrics(DisplayMetrics outMetrics) {
        System.out.println("ShadowDisplay#getRealMetrics");
        if (isJB()) {
    ...
    protected int getDisplayId() {
        System.out.println("ShadowDisplay#getDisplayId");
    ...
    protected float getRefreshRate() {
        System.out.println("ShadowDisplay#getRefreshRate");
        return refreshRate == null ? directlyOn(realObject, Display.class).getRefreshRate() : refreshRate;
    }
    ...
    protected int getPixelFormat() {
        System.out.println("ShadowDisplay#getPixelFormat");
        return pixelFormat == null ? directlyOn(realObject, Display.class).getPixelFormat() : pixelFormat;
    }

    @Implementation(maxSdk = JELLY_BEAN)
    protected void getSizeInternal(Point outSize, boolean doCompat) {
        System.out.println("ShadowDisplay#getSizeInternal");
        outSize.x = width;
        outSize.y = height;
    }
    ...
    protected void getCurrentSizeRange(Point outSmallestSize, Point outLargestSize) {
        System.out.println("ShadowDisplay#getCurrentSizeRange");
    ...
    protected void getRealSize(Point outSize) {
        System.out.println("ShadowDisplay#getRealSize");
    ...
    public void setDensityDpi(int densityDpi) {
        if (isJB()) {
            ...
            ShadowDisplayManager.changeDisplay(realObject.getDisplayId(), di -> di.logicalDensityDpi = densityDpi);
        }
    }
    ...
    void configureForJBOnly(Configuration configuration, DisplayMetrics displayMetrics) {
        ...
        rotation = configuration.orientation == Configuration.ORIENTATION_PORTRAIT ? Surface.ROTATION_0 : Surface.ROTATION_90;
    }
}
