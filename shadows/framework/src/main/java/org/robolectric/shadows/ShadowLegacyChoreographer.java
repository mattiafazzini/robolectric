...
public class ShadowLegacyChoreographer extends ShadowChoreographer {
    ...
    // 10ms
    private static long FRAME_INTERVAL = 10 * TimeUtils.NANOS_PER_MS;
    ...
    protected static Choreographer getInstance() {
        System.out.println("ShadowLegacyChoreographer#getInstance");
        return instance.get();
    }
    ...
    protected void postCallback(int callbackType, Runnable action, Object token) {
        System.out.println("ShadowLegacyChoreographer#postCallback");
    ...
    protected void postCallbackDelayed(int callbackType, Runnable action, Object token, long delayMillis) {
        System.out.println("ShadowLegacyChoreographer#postCallbackDelayed");
        handler.postDelayed(action, delayMillis);
    }

    @Implementation
    protected void removeCallbacks(int callbackType, Runnable action, Object token) {
        System.out.println("ShadowLegacyChoreographer#removeCallbacks");
    ...
    protected void postFrameCallback(final FrameCallback callback) {
        System.out.println("ShadowLegacyChoreographer#postFrameCallback");
    ...
    protected void postFrameCallbackDelayed(final FrameCallback callback, long delayMillis) {
        System.out.println("ShadowLegacyChoreographer#postFrameCallbackDelayed");
    ...
    protected void removeFrameCallback(FrameCallback callback) {
        System.out.println("ShadowLegacyChoreographer#removeFrameCallback");
        handler.removeCallbacksAndMessages(callback);
    }

    @Implementation
    protected long getFrameTimeNanos() {
        System.out.println("ShadowLegacyChoreographer#getFrameTimeNanos");
    ...
    public static synchronized void reset() {
        ...
        // 10ms
        FRAME_INTERVAL = 10 * TimeUtils.NANOS_PER_MS;
    }
}
