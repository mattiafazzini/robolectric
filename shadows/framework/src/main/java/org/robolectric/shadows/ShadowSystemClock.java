...
public class ShadowSystemClock {
    ...
    protected static void sleep(long millis) {
        System.out.println("ShadowSystemClock#sleep");
        if (ShadowApplication.getInstance() == null) {
            return;
        }
    ...
    protected static boolean setCurrentTimeMillis(long millis) {
        System.out.println("ShadowSystemClock#setCurrentTimeMillis");
        if (ShadowApplication.getInstance() == null) {
            return false;
        }
        if (now() > millis) {
    ...
    protected static long uptimeMillis() {
        System.out.println("ShadowSystemClock#uptimeMillis");
        return now() - bootedAt;
    }

    @Implementation
    protected static long elapsedRealtime() {
        System.out.println("ShadowSystemClock#elapsedRealtime");
        return uptimeMillis();
    }

    @Implementation(minSdk = JELLY_BEAN_MR1)
    protected static long elapsedRealtimeNanos() {
        System.out.println("ShadowSystemClock#elapsedRealtimeNanos");
        return elapsedRealtime() * MILLIS_PER_NANO;
    }

    @Implementation
    protected static long currentThreadTimeMillis() {
        System.out.println("ShadowSystemClock#currentThreadTimeMillis");
        return uptimeMillis();
    }
    ...
    public static long currentThreadTimeMicro() {
        System.out.println("ShadowSystemClock#currentThreadTimeMicro");
    ...
    public static long currentTimeMicro() {
        System.out.println("ShadowSystemClock#currentTimeMicro");
        return now() * 1000;
    }
    ...
    protected static long currentNetworkTimeMillis() {
        System.out.println("ShadowSystemClock#currentNetworkTimeMillis");
