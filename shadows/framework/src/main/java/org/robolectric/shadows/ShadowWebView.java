...
public class ShadowWebView extends ShadowViewGroup {
    ...
    public void ensureProviderCreated() {
        System.out.println("ShadowWebView#ensureProviderCreated");
    ...
    protected void setLayoutParams(LayoutParams params) {
        System.out.println("ShadowWebView#setLayoutParams");
        ReflectionHelpers.setField(realWebView, "mLayoutParams", params);
    }

    private Object nullish(Method method) {
        Class<?> returnType = method.getReturnType();
        if (returnType.equals(long.class) || returnType.equals(double.class) || returnType.equals(int.class) || returnType.equals(float.class) || returnType.equals(short.class) || returnType.equals(byte.class))
            return 0;
    ...
    protected void loadUrl(String url) {
        System.out.println("ShadowWebView#loadUrl");
        loadUrl(url, null);
    }
    ...
    protected void loadDataWithBaseURL(String baseUrl, String data, String mimeType, String encoding, String historyUrl) {
        System.out.println("ShadowWebView#loadDataWithBaseURL");
        if (historyUrl != null) {
    ...
    protected void loadData(String data, String mimeType, String encoding) {
        System.out.println("ShadowWebView#loadData");
    ...
    protected String getOriginalUrl() {
        System.out.println("ShadowWebView#getOriginalUrl");
        return originalUrl;
    }

    @Implementation
    protected String getUrl() {
        System.out.println("ShadowWebView#getUrl");
        return originalUrl;
    }
    ...
    protected WebSettings getSettings() {
        System.out.println("ShadowWebView#getSettings");
        return webSettings;
    }

    @Implementation
    protected void setWebViewClient(WebViewClient client) {
        System.out.println("ShadowWebView#setWebViewClient");
        webViewClient = client;
    }

    @Implementation
    protected void setWebChromeClient(WebChromeClient client) {
        System.out.println("ShadowWebView#setWebChromeClient");
    ...
    protected void addJavascriptInterface(Object obj, String interfaceName) {
        System.out.println("ShadowWebView#addJavascriptInterface");
    ...
    protected void removeJavascriptInterface(String name) {
        System.out.println("ShadowWebView#removeJavascriptInterface");
        javascriptInterfaces.remove(name);
    }

    @Implementation
    protected void clearCache(boolean includeDiskFiles) {
        System.out.println("ShadowWebView#clearCache");
    ...
    protected void clearFormData() {
        System.out.println("ShadowWebView#clearFormData");
    ...
    protected void clearHistory() {
        System.out.println("ShadowWebView#clearHistory");
    ...
    protected void clearView() {
        System.out.println("ShadowWebView#clearView");
    ...
    protected void onPause() {
        System.out.println("ShadowWebView#onPause");
        onPauseCalled = true;
    }
    ...
    protected void onResume() {
        System.out.println("ShadowWebView#onResume");
        onResumeCalled = true;
    }
    ...
    protected void destroy() {
        System.out.println("ShadowWebView#destroy");
        destroyCalled = true;
    }
    ...
    protected boolean canGoBack() {
        System.out.println("ShadowWebView#canGoBack");
    ...
    protected void goBack() {
        System.out.println("ShadowWebView#goBack");
        if (canGoBack()) {
            goBackInvocations++;
    ...
    protected void goBackOrForward(int steps) {
        System.out.println("ShadowWebView#goBackOrForward");
        if (steps >= 0) {
    ...
    protected WebBackForwardList copyBackForwardList() {
        System.out.println("ShadowWebView#copyBackForwardList");
        return new BackForwardList(history);
    }

    @Implementation
    protected static String findAddress(String addr) {
        System.out.println("ShadowWebView#findAddress");
        return null;
    }
    ...
    protected static PackageInfo getCurrentWebViewPackage() {
        System.out.println("ShadowWebView#getCurrentWebViewPackage");
        return packageInfo;
    }
    ...
    protected void evaluateJavascript(String script, ValueCallback<String> callback) {
        System.out.println("ShadowWebView#evaluateJavascript");
    ...
    protected WebBackForwardList saveState(Bundle outState) {
        System.out.println("ShadowWebView#saveState");
        if (history.size() > 0) {
    ...
    protected WebBackForwardList restoreState(Bundle inState) {
        System.out.println("ShadowWebView#restoreState");
