...
public class ShadowPendingIntent {
    ...
    protected static PendingIntent getActivity(Context context, int requestCode, @NonNull Intent intent, int flags) {
        System.out.println("ShadowPendingIntent#getActivity");
    ...
    protected static PendingIntent getActivities(Context context, int requestCode, @NonNull Intent[] intents, int flags) {
        System.out.println("ShadowPendingIntent#getActivities");
    ...
    protected static PendingIntent getBroadcast(Context context, int requestCode, @NonNull Intent intent, int flags) {
        System.out.println("ShadowPendingIntent#getBroadcast");
    ...
    protected static PendingIntent getService(Context context, int requestCode, @NonNull Intent intent, int flags) {
        System.out.println("ShadowPendingIntent#getService");
    ...
    protected static PendingIntent getForegroundService(Context context, int requestCode, @NonNull Intent intent, int flags) {
        System.out.println("ShadowPendingIntent#getForegroundService");
    ...
    protected void cancel() {
        System.out.println("ShadowPendingIntent#cancel");
        synchronized (lock) {
    ...
    protected void send() throws CanceledException {
        System.out.println("ShadowPendingIntent#send");
    ...
    @Implementation
    protected void send(int code, PendingIntent.OnFinished onFinished, Handler handler) throws CanceledException {
        System.out.println("ShadowPendingIntent#send");
    ...
    @Implementation
    protected void send(Context context, int code, Intent intent, PendingIntent.OnFinished onFinished, Handler handler) throws CanceledException {
        System.out.println("ShadowPendingIntent#send");
        send(context, code, intent, onFinished, handler, null);
    }

    @Implementation
    protected void send(Context context, int code, Intent intent, PendingIntent.OnFinished onFinished, Handler handler, String requiredPermission) throws CanceledException {
        System.out.println("ShadowPendingIntent#send");
    ...
    protected void send(Context context, int code, Intent intent, PendingIntent.OnFinished onFinished, Handler handler, String requiredPermission, Bundle options) throws CanceledException {
        ...
        if (isActivityIntent()) {
            ...
            for (Intent intentToSend : intentsToSend) {
                shadowInstrumentation.sendBroadcastWithPermission(intentToSend, requiredPermission, context, code);
            }
    ...
    protected IntentSender getIntentSender() {
        System.out.println("ShadowPendingIntent#getIntentSender");
    ...
    protected String getTargetPackage() {
        System.out.println("ShadowPendingIntent#getTargetPackage");
        return getCreatorPackage();
    }

    @Implementation(minSdk = JELLY_BEAN_MR1)
    protected String getCreatorPackage() {
        System.out.println("ShadowPendingIntent#getCreatorPackage");
        return (creatorPackage == null) ? RuntimeEnvironment.application.getPackageName() : creatorPackage;
    }
    ...
    public boolean equals(Object o) {
        System.out.println("ShadowPendingIntent#equals");
        if (this == o)
            return true;
        if (o == null || realPendingIntent.getClass() != o.getClass())
            return false;
    ...
    @Implementation
    public int hashCode() {
        System.out.println("ShadowPendingIntent#hashCode");
