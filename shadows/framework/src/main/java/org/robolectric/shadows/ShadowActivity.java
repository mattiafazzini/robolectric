...
public class ShadowActivity extends ShadowContextThemeWrapper {
    ...
    public void callAttach(Intent intent) {
        ...
        Instrumentation instrumentation = ((ActivityThread) RuntimeEnvironment.getActivityThread()).getInstrumentation();
        if (apiLevel <= Build.VERSION_CODES.KITKAT) {
            ReflectionHelpers.callInstanceMethod(Activity.class, realActivity, "attach", ReflectionHelpers.ClassParameter.from(Context.class, baseContext), ReflectionHelpers.ClassParameter.from(ActivityThread.class, RuntimeEnvironment.getActivityThread()), ReflectionHelpers.ClassParameter.from(Instrumentation.class, instrumentation), ReflectionHelpers.ClassParameter.from(IBinder.class, null), ReflectionHelpers.ClassParameter.from(int.class, 0), ReflectionHelpers.ClassParameter.from(Application.class, application), ReflectionHelpers.ClassParameter.from(Intent.class, intent), ReflectionHelpers.ClassParameter.from(ActivityInfo.class, activityInfo), ReflectionHelpers.ClassParameter.from(CharSequence.class, activityTitle), ReflectionHelpers.ClassParameter.from(Activity.class, null), ReflectionHelpers.ClassParameter.from(String.class, "id"), ReflectionHelpers.ClassParameter.from(nonConfigurationInstancesClass, null), ReflectionHelpers.ClassParameter.from(Configuration.class, application.getResources().getConfiguration()));
        } else if (apiLevel <= Build.VERSION_CODES.LOLLIPOP) {
            ReflectionHelpers.callInstanceMethod(Activity.class, realActivity, "attach", ReflectionHelpers.ClassParameter.from(Context.class, baseContext), ReflectionHelpers.ClassParameter.from(ActivityThread.class, RuntimeEnvironment.getActivityThread()), ReflectionHelpers.ClassParameter.from(Instrumentation.class, instrumentation), ReflectionHelpers.ClassParameter.from(IBinder.class, null), ReflectionHelpers.ClassParameter.from(int.class, 0), ReflectionHelpers.ClassParameter.from(Application.class, application), ReflectionHelpers.ClassParameter.from(Intent.class, intent), ReflectionHelpers.ClassParameter.from(ActivityInfo.class, activityInfo), ReflectionHelpers.ClassParameter.from(CharSequence.class, activityTitle), ReflectionHelpers.ClassParameter.from(Activity.class, null), ReflectionHelpers.ClassParameter.from(String.class, "id"), ReflectionHelpers.ClassParameter.from(nonConfigurationInstancesClass, null), ReflectionHelpers.ClassParameter.from(Configuration.class, application.getResources().getConfiguration()), // ADDED
            ReflectionHelpers.ClassParameter.from(IVoiceInteractor.class, null));
        } else if (apiLevel <= Build.VERSION_CODES.M) {
            ReflectionHelpers.callInstanceMethod(Activity.class, realActivity, "attach", ReflectionHelpers.ClassParameter.from(Context.class, baseContext), ReflectionHelpers.ClassParameter.from(ActivityThread.class, RuntimeEnvironment.getActivityThread()), ReflectionHelpers.ClassParameter.from(Instrumentation.class, instrumentation), ReflectionHelpers.ClassParameter.from(IBinder.class, null), ReflectionHelpers.ClassParameter.from(int.class, 0), ReflectionHelpers.ClassParameter.from(Application.class, application), ReflectionHelpers.ClassParameter.from(Intent.class, intent), ReflectionHelpers.ClassParameter.from(ActivityInfo.class, activityInfo), ReflectionHelpers.ClassParameter.from(CharSequence.class, activityTitle), ReflectionHelpers.ClassParameter.from(Activity.class, null), ReflectionHelpers.ClassParameter.from(String.class, "id"), ReflectionHelpers.ClassParameter.from(nonConfigurationInstancesClass, null), ReflectionHelpers.ClassParameter.from(Configuration.class, application.getResources().getConfiguration()), ReflectionHelpers.ClassParameter.from(String.class, "referrer"), ReflectionHelpers.ClassParameter.from(IVoiceInteractor.class, // SAME AS LOLLIPOP ---------------------------
            null));
        } else if (apiLevel <= Build.VERSION_CODES.N_MR1) {
            ReflectionHelpers.callInstanceMethod(Activity.class, realActivity, "attach", ReflectionHelpers.ClassParameter.from(Context.class, baseContext), ReflectionHelpers.ClassParameter.from(ActivityThread.class, RuntimeEnvironment.getActivityThread()), ReflectionHelpers.ClassParameter.from(Instrumentation.class, instrumentation), ReflectionHelpers.ClassParameter.from(IBinder.class, null), ReflectionHelpers.ClassParameter.from(int.class, 0), ReflectionHelpers.ClassParameter.from(Application.class, application), ReflectionHelpers.ClassParameter.from(Intent.class, intent), ReflectionHelpers.ClassParameter.from(ActivityInfo.class, activityInfo), ReflectionHelpers.ClassParameter.from(CharSequence.class, activityTitle), ReflectionHelpers.ClassParameter.from(Activity.class, null), ReflectionHelpers.ClassParameter.from(String.class, "id"), ReflectionHelpers.ClassParameter.from(nonConfigurationInstancesClass, null), ReflectionHelpers.ClassParameter.from(Configuration.class, application.getResources().getConfiguration()), ReflectionHelpers.ClassParameter.from(String.class, "referrer"), ReflectionHelpers.ClassParameter.from(IVoiceInteractor.class, null), // ADDED
            ReflectionHelpers.ClassParameter.from(Window.class, null));
        } else if (apiLevel >= Build.VERSION_CODES.O) {
            ReflectionHelpers.callInstanceMethod(Activity.class, realActivity, "attach", ReflectionHelpers.ClassParameter.from(Context.class, baseContext), ReflectionHelpers.ClassParameter.from(ActivityThread.class, RuntimeEnvironment.getActivityThread()), ReflectionHelpers.ClassParameter.from(Instrumentation.class, instrumentation), ReflectionHelpers.ClassParameter.from(IBinder.class, null), ReflectionHelpers.ClassParameter.from(int.class, 0), ReflectionHelpers.ClassParameter.from(Application.class, application), ReflectionHelpers.ClassParameter.from(Intent.class, intent), ReflectionHelpers.ClassParameter.from(ActivityInfo.class, activityInfo), ReflectionHelpers.ClassParameter.from(CharSequence.class, activityTitle), ReflectionHelpers.ClassParameter.from(Activity.class, null), ReflectionHelpers.ClassParameter.from(String.class, "id"), ReflectionHelpers.ClassParameter.from(nonConfigurationInstancesClass, null), ReflectionHelpers.ClassParameter.from(Configuration.class, application.getResources().getConfiguration()), ReflectionHelpers.ClassParameter.from(String.class, "referrer"), ReflectionHelpers.ClassParameter.from(IVoiceInteractor.class, null), ReflectionHelpers.ClassParameter.from(Window.class, null), ReflectionHelpers.ClassParameter.from(ViewRootImpl.ActivityConfigCallback.class, // ADDED
            null));
        } else {
    ...
    protected ComponentName getCallingActivity() {
        System.out.println("ShadowActivity#getCallingActivity");
        return callingActivity;
    }

    @Implementation
    protected void setDefaultKeyMode(int keyMode) {
        System.out.println("ShadowActivity#setDefaultKeyMode");
    ...
    protected final void setResult(int resultCode) {
        System.out.println("ShadowActivity#setResult");
    ...
    protected LayoutInflater getLayoutInflater() {
        System.out.println("ShadowActivity#getLayoutInflater");
        return LayoutInflater.from(realActivity);
    }

    @Implementation
    protected MenuInflater getMenuInflater() {
        System.out.println("ShadowActivity#getMenuInflater");
    ...
    protected View findViewById(int id) {
        System.out.println("ShadowActivity#findViewById");
        return getWindow().findViewById(id);
    }

    @Implementation
    protected final Activity getParent() {
        System.out.println("ShadowActivity#getParent");
        return parent;
    }
    ...
    public void setParent(Activity parent) {
        System.out.println("ShadowActivity#setParent");
        this.parent = parent;
    }

    @Implementation
    protected void onBackPressed() {
        System.out.println("ShadowActivity#onBackPressed");
        finish();
    }

    @Implementation
    protected void finish() {
        System.out.println("ShadowActivity#finish");
    ...
    protected void finishAndRemoveTask() {
        System.out.println("ShadowActivity#finishAndRemoveTask");
        // Sets the mFinished field in the real activity so NoDisplay activities can be tested.
        ReflectionHelpers.setField(Activity.class, realActivity, "mFinished", true);
    }
    ...
    protected void finishAffinity() {
        System.out.println("ShadowActivity#finishAffinity");
        // Sets the mFinished field in the real activity so NoDisplay activities can be tested.
        ReflectionHelpers.setField(Activity.class, realActivity, "mFinished", true);
    }
    ...
    protected Window getWindow() {
        System.out.println("ShadowActivity#getWindow");
    ...
    protected void runOnUiThread(Runnable action) {
        System.out.println("ShadowActivity#runOnUiThread");
    ...
    protected void setRequestedOrientation(int requestedOrientation) {
        System.out.println("ShadowActivity#setRequestedOrientation");
        if (getParent() != null) {
    ...
    protected int getRequestedOrientation() {
        System.out.println("ShadowActivity#getRequestedOrientation");
        if (getParent() != null) {
    ...
    protected int getTaskId() {
        System.out.println("ShadowActivity#getTaskId");
        return 0;
    }
    ...
    protected Object getLastNonConfigurationInstance() {
        System.out.println("ShadowActivity#getLastNonConfigurationInstance");
    ...
    protected View getCurrentFocus() {
        System.out.println("ShadowActivity#getCurrentFocus");
        return currentFocus;
    }
    ...
    protected boolean onCreateOptionsMenu(Menu menu) {
        System.out.println("ShadowActivity#onCreateOptionsMenu");
        optionsMenu = menu;
    ...
    protected final void showDialog(int id) {
        System.out.println("ShadowActivity#showDialog");
        showDialog(id, null);
    }

    @Implementation
    protected final void dismissDialog(int id) {
        System.out.println("ShadowActivity#dismissDialog");
    ...
    protected final void removeDialog(int id) {
        System.out.println("ShadowActivity#removeDialog");
    ...
    protected final boolean isTaskRoot() {
        System.out.println("ShadowActivity#isTaskRoot");
        return mIsTaskRoot;
    }
    ...
    protected void overridePendingTransition(int enterAnim, int exitAnim) {
        System.out.println("ShadowActivity#overridePendingTransition");
    ...
    protected void recreate() {
        System.out.println("ShadowActivity#recreate");
    ...
    protected void startManagingCursor(Cursor c) {
        System.out.println("ShadowActivity#startManagingCursor");
        managedCursors.add(c);
    }

    @Implementation
    protected void stopManagingCursor(Cursor c) {
        System.out.println("ShadowActivity#stopManagingCursor");
    ...
    protected final void setVolumeControlStream(int streamType) {
        System.out.println("ShadowActivity#setVolumeControlStream");
        this.streamType = streamType;
    }

    @Implementation
    protected final int getVolumeControlStream() {
        System.out.println("ShadowActivity#getVolumeControlStream");
        return streamType;
    }
    ...
    protected void startLockTask() {
        System.out.println("ShadowActivity#startLockTask");
        Shadow.<ShadowActivityManager>extract(getActivityManager()).setLockTaskModeState(ActivityManager.LOCK_TASK_MODE_LOCKED);
    }
    ...
    protected void stopLockTask() {
        System.out.println("ShadowActivity#stopLockTask");
        Shadow.<ShadowActivityManager>extract(getActivityManager()).setLockTaskModeState(ActivityManager.LOCK_TASK_MODE_NONE);
    }
