...
public class ShadowActivity extends ShadowContextThemeWrapper {
    ...
    public void callAttach(Intent intent) {
        callAttach(intent, /*lastNonConfigurationInstances=*/
        null);
    }

    public void callAttach(Intent intent, @Nullable @WithType("android.app.Activity$NonConfigurationInstances") Object lastNonConfigurationInstances) {
        ...
        reflector(_Activity_.class, realActivity).callAttach(baseContext, activityThread, instrumentation, application, intent, activityInfo, activityTitle, lastNonConfigurationInstances);
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int requestCode, @Nullable Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException {
        System.out.println("ShadowActivity#startIntentSenderForResult");
        if (throwIntentSenderException) {
            throw new IntentSender.SendIntentException("PendingIntent was canceled");
        }
        lastIntentSenderRequest = new IntentSenderRequest(intentSender, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, options);
    }
    ...
    protected final void requestPermissions(String[] permissions, int requestCode) {
        System.out.println("ShadowActivity#requestPermissions");
    ...
    protected boolean isInMultiWindowMode() {
        System.out.println("ShadowActivity#isInMultiWindowMode");
