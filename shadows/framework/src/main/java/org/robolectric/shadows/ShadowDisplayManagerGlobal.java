...
public class ShadowDisplayManagerGlobal {
    ...
    synchronized public static DisplayManagerGlobal getInstance() {
        System.out.println("ShadowDisplayManagerGlobal#getInstance");
        if (instance == null) {
    ...
    protected WifiDisplayStatus getWifiDisplayStatus() {
        System.out.println("ShadowDisplayManagerGlobal#getWifiDisplayStatus");
    ...
    public Point getStableDisplaySize() throws RemoteException {
        System.out.println("ShadowDisplayManagerGlobal#getStableDisplaySize");
    ...
    protected void setSaturationLevel(float level) {
        System.out.println("ShadowDisplayManagerGlobal#setSaturationLevel");
