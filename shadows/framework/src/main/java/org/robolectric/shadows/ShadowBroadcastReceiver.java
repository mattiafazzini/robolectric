...
public class ShadowBroadcastReceiver {
    ...
    protected void abortBroadcast() {
        System.out.println("ShadowBroadcastReceiver#abortBroadcast");
    ...
    protected void onReceive(Context context, Intent intent) {
        System.out.println("ShadowBroadcastReceiver#onReceive");
    ...
    protected PendingResult goAsync() {
        System.out.println("ShadowBroadcastReceiver#goAsync");
