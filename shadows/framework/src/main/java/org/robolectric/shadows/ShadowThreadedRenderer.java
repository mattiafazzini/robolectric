...
@Implements(className = "android.view.ThreadedRenderer", isInAndroidSdk = false, looseSignatures = true, minSdk = O, maxSdk = P)
public class ShadowThreadedRenderer {
    ...
    Object width, /*int*/
    Object height) {
        System.out.println("ShadowThreadedRenderer#createHardwareBitmap");
