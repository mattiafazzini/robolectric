...
public class ShadowUsbManager {
    ...
    public void addPort(String portId) {
        usbPorts.put(new UsbPort(portId, UsbPort.MODE_DUAL), new UsbPortStatus(UsbPort.MODE_DUAL, UsbPort.POWER_ROLE_SINK, UsbPort.DATA_ROLE_DEVICE, 0));
    }
    ...
    Object dataRole) {
        ...
        usbPorts.put((UsbPort) port, new UsbPortStatus(status.getCurrentMode(), (int) powerRole, (int) dataRole, status.getSupportedRoleCombinations()));
