...
public class ShadowAppWidgetManager {
    ...
    protected void __constructor__(Context context) {
        System.out.println("ShadowAppWidgetManager#__constructor__");
    ...
    protected void updateAppWidget(int[] appWidgetIds, RemoteViews views) {
        System.out.println("ShadowAppWidgetManager#updateAppWidget");
    ...
    protected int[] getAppWidgetIds(ComponentName provider) {
        System.out.println("ShadowAppWidgetManager#getAppWidgetIds");
    ...
    protected List<AppWidgetProviderInfo> getInstalledProviders() {
        System.out.println("ShadowAppWidgetManager#getInstalledProviders");
    ...
    protected AppWidgetProviderInfo getAppWidgetInfo(int appWidgetId) {
        System.out.println("ShadowAppWidgetManager#getAppWidgetInfo");
        WidgetInfo widgetInfo = widgetInfos.get(appWidgetId);
        if (widgetInfo == null)
            return null;
    ...
    public void bindAppWidgetId(int appWidgetId, ComponentName provider) {
        System.out.println("ShadowAppWidgetManager#bindAppWidgetId");
    ...
    protected boolean bindAppWidgetIdIfAllowed(int appWidgetId, ComponentName provider) {
        System.out.println("ShadowAppWidgetManager#bindAppWidgetIdIfAllowed");
