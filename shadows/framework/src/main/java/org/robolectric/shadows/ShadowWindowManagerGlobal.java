...
@Implements(value = WindowManagerGlobal.class, isInAndroidSdk = false, minSdk = JELLY_BEAN_MR1, looseSignatures = true)
public class ShadowWindowManagerGlobal {
    ...
    public static Object getWindowSession() {
        System.out.println("ShadowWindowManagerGlobal#getWindowSession");
        return null;
    }
    ...
    public static Object getWindowManagerService() {
        System.out.println("ShadowWindowManagerGlobal#getWindowManagerService");
        return null;
    }
}
