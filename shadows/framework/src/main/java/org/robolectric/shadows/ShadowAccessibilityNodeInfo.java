...
public class ShadowAccessibilityNodeInfo {
    ...
    // 14
    private static final int CHECKABLE_MASK = 0x00001000;

    // 14
    private static final int CHECKED_MASK = 0x00002000;

    // 14
    private static final int ENABLED_MASK = 0x00010000;

    // 14
    private static final int PASSWORD_MASK = 0x00040000;

    // 14
    private static final int SELECTED_MASK = 0x00080000;

    // 16
    private static final int A11YFOCUSED_MASK = 0x00000800;

    // 19
    private static final int MULTILINE_MASK = 0x00020000;

    // 19
    private static final int CONTENT_INVALID_MASK = 0x00004000;

    // 19
    private static final int DISMISSABLE_MASK = 0x00008000;

    // 19
    private static final int CAN_OPEN_POPUP_MASK = 0x00100000;
    ...
    protected void __constructor__() {
        System.out.println("ShadowAccessibilityNodeInfo#__constructor__");
    ...
    protected static AccessibilityNodeInfo obtain(AccessibilityNodeInfo info) {
        System.out.println("ShadowAccessibilityNodeInfo#obtain");
    ...
    protected void recycle() {
        System.out.println("ShadowAccessibilityNodeInfo#recycle");
        final StrictEqualityNodeWrapper wrapper = new StrictEqualityNodeWrapper(realAccessibilityNodeInfo);
    ...
    protected int getChildCount() {
        System.out.println("ShadowAccessibilityNodeInfo#getChildCount");
        if (children == null) {
            return 0;
        }
    ...
    protected AccessibilityNodeInfo getChild(int index) {
        System.out.println("ShadowAccessibilityNodeInfo#getChild");
        if (children == null) {
            return null;
        }
    ...
    protected AccessibilityNodeInfo getParent() {
        System.out.println("ShadowAccessibilityNodeInfo#getParent");
        if (parent == null) {
            return null;
        }
    ...
    protected boolean refresh() {
        System.out.println("ShadowAccessibilityNodeInfo#refresh");
    ...
    protected boolean isClickable() {
        System.out.println("ShadowAccessibilityNodeInfo#isClickable");
        return ((propertyFlags & CLICKABLE_MASK) != 0);
    }

    @Implementation
    protected boolean isLongClickable() {
        System.out.println("ShadowAccessibilityNodeInfo#isLongClickable");
        return ((propertyFlags & LONGCLICKABLE_MASK) != 0);
    }

    @Implementation
    protected boolean isFocusable() {
        System.out.println("ShadowAccessibilityNodeInfo#isFocusable");
        return ((propertyFlags & FOCUSABLE_MASK) != 0);
    }

    @Implementation
    protected boolean isFocused() {
        System.out.println("ShadowAccessibilityNodeInfo#isFocused");
        return ((propertyFlags & FOCUSED_MASK) != 0);
    }

    @Implementation
    protected boolean isVisibleToUser() {
        System.out.println("ShadowAccessibilityNodeInfo#isVisibleToUser");
        return ((propertyFlags & VISIBLE_TO_USER_MASK) != 0);
    }

    @Implementation
    protected boolean isScrollable() {
        System.out.println("ShadowAccessibilityNodeInfo#isScrollable");
    ...
    protected boolean isEditable() {
        System.out.println("ShadowAccessibilityNodeInfo#isEditable");
    ...
    protected void setLongClickable(boolean isLongClickable) {
        System.out.println("ShadowAccessibilityNodeInfo#setLongClickable");
        propertyFlags = (propertyFlags & ~LONGCLICKABLE_MASK) | (isLongClickable ? LONGCLICKABLE_MASK : 0);
    }

    @Implementation
    protected void setFocusable(boolean isFocusable) {
        System.out.println("ShadowAccessibilityNodeInfo#setFocusable");
        propertyFlags = (propertyFlags & ~FOCUSABLE_MASK) | (isFocusable ? FOCUSABLE_MASK : 0);
    }

    @Implementation
    protected void setFocused(boolean isFocused) {
        System.out.println("ShadowAccessibilityNodeInfo#setFocused");
        propertyFlags = (propertyFlags & ~FOCUSED_MASK) | (isFocused ? FOCUSED_MASK : 0);
    }

    @Implementation
    protected void setScrollable(boolean isScrollable) {
        System.out.println("ShadowAccessibilityNodeInfo#setScrollable");
    ...
    protected void setEditable(boolean isEditable) {
        System.out.println("ShadowAccessibilityNodeInfo#setEditable");
    ...
    protected void setVisibleToUser(boolean isVisibleToUser) {
        System.out.println("ShadowAccessibilityNodeInfo#setVisibleToUser");
        propertyFlags = (propertyFlags & ~VISIBLE_TO_USER_MASK) | (isVisibleToUser ? VISIBLE_TO_USER_MASK : 0);
    }

    @Implementation
    protected void setContentDescription(CharSequence description) {
        System.out.println("ShadowAccessibilityNodeInfo#setContentDescription");
        contentDescription = description;
    }

    @Implementation
    protected CharSequence getContentDescription() {
        System.out.println("ShadowAccessibilityNodeInfo#getContentDescription");
        return contentDescription;
    }

    @Implementation
    protected void setClassName(CharSequence name) {
        System.out.println("ShadowAccessibilityNodeInfo#setClassName");
        className = name;
    }

    @Implementation
    protected CharSequence getClassName() {
        System.out.println("ShadowAccessibilityNodeInfo#getClassName");
        return className;
    }

    @Implementation
    protected void setText(CharSequence t) {
        System.out.println("ShadowAccessibilityNodeInfo#setText");
        text = t;
    }

    @Implementation
    protected CharSequence getText() {
        System.out.println("ShadowAccessibilityNodeInfo#getText");
        return text;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected void setTextSelection(int start, int end) {
        System.out.println("ShadowAccessibilityNodeInfo#setTextSelection");
    ...
    protected int getTextSelectionStart() {
        System.out.println("ShadowAccessibilityNodeInfo#getTextSelectionStart");
    ...
    protected int getTextSelectionEnd() {
        System.out.println("ShadowAccessibilityNodeInfo#getTextSelectionEnd");
        return textSelectionEnd;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected AccessibilityNodeInfo getLabelFor() {
        System.out.println("ShadowAccessibilityNodeInfo#getLabelFor");
        if (labelFor == null) {
            return null;
        }
    ...
    protected AccessibilityNodeInfo getLabeledBy() {
        System.out.println("ShadowAccessibilityNodeInfo#getLabeledBy");
        if (labeledBy == null) {
            return null;
        }
    ...
    protected int getMovementGranularities() {
        System.out.println("ShadowAccessibilityNodeInfo#getMovementGranularities");
        return movementGranularities;
    }

    @Implementation
    protected void setMovementGranularities(int movementGranularities) {
        System.out.println("ShadowAccessibilityNodeInfo#setMovementGranularities");
        this.movementGranularities = movementGranularities;
    }

    @Implementation
    protected CharSequence getPackageName() {
        System.out.println("ShadowAccessibilityNodeInfo#getPackageName");
        return packageName;
    }

    @Implementation
    protected void setPackageName(CharSequence packageName) {
        System.out.println("ShadowAccessibilityNodeInfo#setPackageName");
        this.packageName = packageName;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected String getViewIdResourceName() {
        System.out.println("ShadowAccessibilityNodeInfo#getViewIdResourceName");
        return viewIdResourceName;
    }

    @Implementation(minSdk = JELLY_BEAN_MR2)
    protected void setViewIdResourceName(String viewIdResourceName) {
        System.out.println("ShadowAccessibilityNodeInfo#setViewIdResourceName");
        this.viewIdResourceName = viewIdResourceName;
    }

    @Implementation(minSdk = KITKAT)
    protected CollectionInfo getCollectionInfo() {
        System.out.println("ShadowAccessibilityNodeInfo#getCollectionInfo");
        return collectionInfo;
    }

    @Implementation(minSdk = KITKAT)
    protected void setCollectionInfo(CollectionInfo collectionInfo) {
        System.out.println("ShadowAccessibilityNodeInfo#setCollectionInfo");
        this.collectionInfo = collectionInfo;
    }

    @Implementation(minSdk = KITKAT)
    protected CollectionItemInfo getCollectionItemInfo() {
        System.out.println("ShadowAccessibilityNodeInfo#getCollectionItemInfo");
        return collectionItemInfo;
    }

    @Implementation(minSdk = KITKAT)
    protected void setCollectionItemInfo(CollectionItemInfo collectionItemInfo) {
        System.out.println("ShadowAccessibilityNodeInfo#setCollectionItemInfo");
        this.collectionItemInfo = collectionItemInfo;
    }

    @Implementation(minSdk = KITKAT)
    protected int getInputType() {
        System.out.println("ShadowAccessibilityNodeInfo#getInputType");
        return inputType;
    }

    @Implementation(minSdk = KITKAT)
    protected void setInputType(int inputType) {
        System.out.println("ShadowAccessibilityNodeInfo#setInputType");
        this.inputType = inputType;
    }

    @Implementation(minSdk = KITKAT)
    protected int getLiveRegion() {
        System.out.println("ShadowAccessibilityNodeInfo#getLiveRegion");
        return liveRegion;
    }

    @Implementation(minSdk = KITKAT)
    protected void setLiveRegion(int liveRegion) {
        System.out.println("ShadowAccessibilityNodeInfo#setLiveRegion");
        this.liveRegion = liveRegion;
    }

    @Implementation(minSdk = KITKAT)
    protected RangeInfo getRangeInfo() {
        System.out.println("ShadowAccessibilityNodeInfo#getRangeInfo");
        return rangeInfo;
    }

    @Implementation(minSdk = KITKAT)
    protected void setRangeInfo(RangeInfo rangeInfo) {
        System.out.println("ShadowAccessibilityNodeInfo#setRangeInfo");
        this.rangeInfo = rangeInfo;
    }

    @Implementation(minSdk = LOLLIPOP)
    protected int getMaxTextLength() {
        System.out.println("ShadowAccessibilityNodeInfo#getMaxTextLength");
        return maxTextLength;
    }

    @Implementation(minSdk = LOLLIPOP)
    protected void setMaxTextLength(int maxTextLength) {
        System.out.println("ShadowAccessibilityNodeInfo#setMaxTextLength");
        this.maxTextLength = maxTextLength;
    }

    @Implementation(minSdk = LOLLIPOP)
    protected CharSequence getError() {
        System.out.println("ShadowAccessibilityNodeInfo#getError");
        return error;
    }

    @Implementation(minSdk = LOLLIPOP)
    protected void setError(CharSequence error) {
        System.out.println("ShadowAccessibilityNodeInfo#setError");
        this.error = error;
    }

    @Implementation(minSdk = LOLLIPOP_MR1)
    protected AccessibilityNodeInfo getTraversalAfter() {
        System.out.println("ShadowAccessibilityNodeInfo#getTraversalAfter");
        if (traversalAfter == null) {
            return null;
        }
    ...
    protected void setTraversalAfter(View view, int virtualDescendantId) {
        System.out.println("ShadowAccessibilityNodeInfo#setTraversalAfter");
    ...
    protected AccessibilityNodeInfo getTraversalBefore() {
        System.out.println("ShadowAccessibilityNodeInfo#getTraversalBefore");
        if (traversalBefore == null) {
            return null;
        }
    ...
    protected void setTraversalBefore(View info, int virtualDescendantId) {
        System.out.println("ShadowAccessibilityNodeInfo#setTraversalBefore");
    ...
    protected void setSource(View source) {
        System.out.println("ShadowAccessibilityNodeInfo#setSource");
        this.view = source;
    }
    ...
    protected void getBoundsInScreen(Rect outBounds) {
        System.out.println("ShadowAccessibilityNodeInfo#getBoundsInScreen");
    ...
    protected void getBoundsInParent(Rect outBounds) {
        System.out.println("ShadowAccessibilityNodeInfo#getBoundsInParent");
    ...
    protected void setBoundsInScreen(Rect b) {
        System.out.println("ShadowAccessibilityNodeInfo#setBoundsInScreen");
        if (boundsInScreen == null) {
    ...
    protected void setBoundsInParent(Rect b) {
        System.out.println("ShadowAccessibilityNodeInfo#setBoundsInParent");
        if (boundsInParent == null) {
    ...
    protected void addAction(int action) {
        System.out.println("ShadowAccessibilityNodeInfo#addAction");
    ...
    protected void removeAction(int action) {
        System.out.println("ShadowAccessibilityNodeInfo#removeAction");
    ...
    protected int getActions() {
        System.out.println("ShadowAccessibilityNodeInfo#getActions");
        if (getApiLevel() >= LOLLIPOP) {
            int returnValue = 0;
            if (actionsArray == null) {
                return returnValue;
    ...
    protected int getDrawingOrder() {
        System.out.println("ShadowAccessibilityNodeInfo#getDrawingOrder");
        return drawingOrder;
    }
    ...
    protected void setDrawingOrder(int drawingOrder) {
        System.out.println("ShadowAccessibilityNodeInfo#setDrawingOrder");
        this.drawingOrder = drawingOrder;
    }

    @Implementation(minSdk = LOLLIPOP)
    protected AccessibilityWindowInfo getWindow() {
        System.out.println("ShadowAccessibilityNodeInfo#getWindow");
    ...
    protected int getWindowId() {
        System.out.println("ShadowAccessibilityNodeInfo#getWindowId");
    ...
    protected List<AccessibilityAction> getActionList() {
        System.out.println("ShadowAccessibilityNodeInfo#getActionList");
        if (actionsArray == null) {
    ...
    protected boolean performAction(int action) {
        System.out.println("ShadowAccessibilityNodeInfo#performAction");
    ...
    public boolean equals(Object object) {
        System.out.println("ShadowAccessibilityNodeInfo#equals");
    ...
    @Override
    public int hashCode() {
        System.out.println("ShadowAccessibilityNodeInfo#hashCode");
    ...
    protected void addChild(View child) {
        System.out.println("ShadowAccessibilityNodeInfo#addChild");
    ...
    private AccessibilityNodeInfo getClone() {
        ...
        // non-shadow objects.
        final AccessibilityNodeInfo newInfo = ReflectionHelpers.callConstructor(AccessibilityNodeInfo.class);
        ...
        if ((getApiLevel() >= LOLLIPOP) && (accessibilityWindowInfo != null)) {
            newShadow.accessibilityWindowInfo = ShadowAccessibilityWindowInfo.obtain(accessibilityWindowInfo);
        }
        if (getApiLevel() >= N) {
    ...
    public static final class ShadowAccessibilityAction {
        ...
        protected void __constructor__(int id, CharSequence label) {
            System.out.println("ShadowAccessibilityAction#__constructor__");
        ...
        @Implementation
        protected int getId() {
            System.out.println("ShadowAccessibilityAction#getId");
            return id;
        }

        @Implementation
        protected CharSequence getLabel() {
            System.out.println("ShadowAccessibilityAction#getLabel");
            return label;
        }
        ...
        public boolean equals(Object other) {
            System.out.println("ShadowAccessibilityAction#equals");
            if (other == null) {
                return false;
            }
            if (other == this) {
        ...
        public String toString() {
            String actionSybolicName = ReflectionHelpers.callStaticMethod(AccessibilityNodeInfo.class, "getActionSymbolicName", ClassParameter.from(int.class, id));
    ...
    protected int describeContents() {
        System.out.println("ShadowAccessibilityNodeInfo#describeContents");
        return 0;
    }

    @Implementation
    protected void writeToParcel(Parcel dest, int flags) {
        System.out.println("ShadowAccessibilityNodeInfo#writeToParcel");
    ...
    private static AccessibilityAction getActionFromIdFromFrameWork(int id) {
        ...
        return ReflectionHelpers.callStaticMethod(AccessibilityNodeInfo.class, "getActionSingleton", ClassParameter.from(int.class, id));
    }
