...
public class ShadowBluetoothDevice {
    ...
    public static BluetoothDevice newInstance(String address) {
        return ReflectionHelpers.callConstructor(BluetoothDevice.class, ReflectionHelpers.ClassParameter.from(String.class, address));
    }
    ...
    protected static IBluetooth getService() {
        System.out.println("ShadowBluetoothDevice#getService");
        // capability.
        try {
    ...
    protected String getName() {
        System.out.println("ShadowBluetoothDevice#getName");
        return name;
    }
    ...
    protected int getType() {
        System.out.println("ShadowBluetoothDevice#getType");
        return type;
    }
    ...
    protected ParcelUuid[] getUuids() {
        System.out.println("ShadowBluetoothDevice#getUuids");
        return uuids;
    }
    ...
    protected int getBondState() {
        System.out.println("ShadowBluetoothDevice#getBondState");
        return bondState;
    }
    ...
    protected boolean createBond() {
        System.out.println("ShadowBluetoothDevice#createBond");
        return createdBond;
    }
    ...
    protected boolean fetchUuidsWithSdp() {
        System.out.println("ShadowBluetoothDevice#fetchUuidsWithSdp");
    ...
    protected BluetoothGatt connectGatt(Context context, boolean autoConnect, BluetoothGattCallback callback) {
        System.out.println("ShadowBluetoothDevice#connectGatt");
