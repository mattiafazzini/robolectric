...
public class ShadowSoundPool {
    ...
    protected static IAudioService getService() {
        System.out.println("ShadowSoundPool#getService");
    ...
    protected int play(int soundID, float leftVolume, float rightVolume, int priority, int loop, float rate) {
        System.out.println("ShadowSoundPool#play");
    ...
    protected int _play(int soundID, float leftVolume, float rightVolume, int priority, int loop, float rate) {
        System.out.println("ShadowSoundPool#_play");
        playedSounds.add(new Playback(soundID, leftVolume, rightVolume, priority, loop, rate));
        return 1;
    }
    ...
    protected int load(String path, int priority) {
        System.out.println("ShadowSoundPool#load");
    ...
    protected void setOnLoadCompleteListener(OnLoadCompleteListener listener) {
        System.out.println("ShadowSoundPool#setOnLoadCompleteListener");
