...
public class ShadowDialog {
    ...
    @Implementation
    protected void show() {
        System.out.println("ShadowDialog#show");
    ...
    protected void dismiss() {
        System.out.println("ShadowDialog#dismiss");
    ...
    protected void setCanceledOnTouchOutside(boolean flag) {
        System.out.println("ShadowDialog#setCanceledOnTouchOutside");
    ...
    protected void setOnCancelListener(DialogInterface.OnCancelListener listener) {
        System.out.println("ShadowDialog#setOnCancelListener");
