...
public class ShadowNetworkCapabilities {
    ...
    public NetworkCapabilities addTransportType(int transportType) {
        System.out.println("ShadowNetworkCapabilities#addTransportType");
        return directlyOn(realNetworkCapabilities, NetworkCapabilities.class, "addTransportType", ClassParameter.from(int.class, transportType));
    }
    ...
    public NetworkCapabilities removeTransportType(int transportType) {
        System.out.println("ShadowNetworkCapabilities#removeTransportType");
        return directlyOn(realNetworkCapabilities, NetworkCapabilities.class, "removeTransportType", ClassParameter.from(int.class, transportType));
    }
}
