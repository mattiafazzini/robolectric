...
public class ShadowCrossProfileApps {
    ...
    protected void __constructor__(Context context, ICrossProfileApps service) {
        System.out.println("ShadowCrossProfileApps#__constructor__");
    ...
    protected List<UserHandle> getTargetUserProfiles() {
        System.out.println("ShadowCrossProfileApps#getTargetUserProfiles");
    ...
    protected Drawable getProfileSwitchingIconDrawable(UserHandle userHandle) {
        System.out.println("ShadowCrossProfileApps#getProfileSwitchingIconDrawable");
    ...
    protected CharSequence getProfileSwitchingLabel(UserHandle userHandle) {
        System.out.println("ShadowCrossProfileApps#getProfileSwitchingLabel");
        verifyCanAccessUser(userHandle);
    ...
    protected void startMainActivity(ComponentName componentName, UserHandle targetUser) {
        System.out.println("ShadowCrossProfileApps#startMainActivity");
    ...
    private void verifyMainActivityInManifest(ComponentName component) {
        Intent launchIntent = new Intent(Intent.ACTION_MAIN).addCategory(Intent.CATEGORY_LAUNCHER).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED).setPackage(component.getPackageName());
        boolean existsMatchingActivity = Iterables.any(packageManager.queryIntentActivities(launchIntent, MATCH_DIRECT_BOOT_AWARE | MATCH_DIRECT_BOOT_UNAWARE), resolveInfo -> {
            ActivityInfo activityInfo = resolveInfo.activityInfo;
            return TextUtils.equals(activityInfo.packageName, component.getPackageName()) && TextUtils.equals(activityInfo.name, component.getClassName()) && activityInfo.exported;
        });
    ...
    public static class StartedMainActivity {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(componentName, that.componentName) && Objects.equals(userHandle, that.userHandle);
        }
