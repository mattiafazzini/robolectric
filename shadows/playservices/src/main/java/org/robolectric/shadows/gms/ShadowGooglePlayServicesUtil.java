...
public class ShadowGooglePlayServicesUtil {
    ...
    public static synchronized Context getRemoteContext(Context context) {
        System.out.println("ShadowGooglePlayServicesUtil#getRemoteContext");
    ...
    public static synchronized Resources getRemoteResource(Context context) {
        System.out.println("ShadowGooglePlayServicesUtil#getRemoteResource");
        return googlePlayServicesUtilImpl.getRemoteResource(context);
    }

    @Implementation
    public static synchronized boolean showErrorDialogFragment(int errorCode, Activity activity, Fragment fragment, int requestCode, OnCancelListener cancelListener) {
        System.out.println("ShadowGooglePlayServicesUtil#showErrorDialogFragment");
        return googlePlayServicesUtilImpl.showErrorDialogFragment(errorCode, activity, fragment, requestCode, cancelListener);
    }

    @Implementation
    public static synchronized boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode) {
        System.out.println("ShadowGooglePlayServicesUtil#showErrorDialogFragment");
        return googlePlayServicesUtilImpl.showErrorDialogFragment(errorCode, activity, requestCode);
    }

    @Implementation
    public static synchronized boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        System.out.println("ShadowGooglePlayServicesUtil#showErrorDialogFragment");
        return googlePlayServicesUtilImpl.showErrorDialogFragment(errorCode, activity, requestCode, cancelListener);
    }

    @Implementation
    public static synchronized Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        System.out.println("ShadowGooglePlayServicesUtil#getErrorDialog");
        return googlePlayServicesUtilImpl.getErrorDialog(errorCode, activity, requestCode);
    }

    @Implementation
    public static synchronized Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        System.out.println("ShadowGooglePlayServicesUtil#getErrorDialog");
        return googlePlayServicesUtilImpl.getErrorDialog(errorCode, activity, requestCode, cancelListener);
    }

    @Implementation
    public static synchronized PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        System.out.println("ShadowGooglePlayServicesUtil#getErrorPendingIntent");
    ...
    public static synchronized String getOpenSourceSoftwareLicenseInfo(Context context) {
        System.out.println("ShadowGooglePlayServicesUtil#getOpenSourceSoftwareLicenseInfo");
    ...
    public static synchronized int isGooglePlayServicesAvailable(Context context) {
        System.out.println("ShadowGooglePlayServicesUtil#isGooglePlayServicesAvailable");
    ...
    public static synchronized void showErrorNotification(int errorCode, Context context) {
        System.out.println("ShadowGooglePlayServicesUtil#showErrorNotification");
    ...
    public static class GooglePlayServicesUtilImpl {
        ...
        public Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        ...
        public PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
            ...
            return PendingIntent.getActivity(context, requestCode, new Intent(), PendingIntent.FLAG_CANCEL_CURRENT);
        }
        ...
        public boolean showErrorDialogFragment(int errorCode, Activity activity, Fragment fragment, int requestCode, OnCancelListener cancelListener) {
            return false;
        }
        ...
        public boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
            return false;
        }
