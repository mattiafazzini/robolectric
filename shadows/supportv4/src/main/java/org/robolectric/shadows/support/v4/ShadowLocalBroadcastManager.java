...
public class ShadowLocalBroadcastManager {
    ...
    protected static LocalBroadcastManager getInstance(final Context context) {
        System.out.println("ShadowLocalBroadcastManager#getInstance");
    ...
    protected void registerReceiver(BroadcastReceiver receiver, IntentFilter filter) {
        System.out.println("ShadowLocalBroadcastManager#registerReceiver");
        registeredReceivers.add(new Wrapper(receiver, filter));
    }

    @Implementation
    protected void unregisterReceiver(BroadcastReceiver receiver) {
        System.out.println("ShadowLocalBroadcastManager#unregisterReceiver");
    ...
    protected boolean sendBroadcast(Intent intent) {
        System.out.println("ShadowLocalBroadcastManager#sendBroadcast");
        boolean sent = false;
