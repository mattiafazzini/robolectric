   ...
   */
    ...
    public static class ShadowClassWithPrivateConstructor {
        ...
        protected int getInt() {
            System.out.println("ShadowClassWithPrivateConstructor#getInt");
            return 42;
        }
    }
    ...
    public static class ShadowCustomPaint extends ShadowPaintForTests {
        ...
        @Implementation
        protected int getColor() {
            System.out.println("ShadowCustomPaint#getColor");
            return 10;
        }

        @Implementation
        protected String getColorName() {
            System.out.println("ShadowCustomPaint#getColorName");
            return "rainbow";
        }
    }
}
