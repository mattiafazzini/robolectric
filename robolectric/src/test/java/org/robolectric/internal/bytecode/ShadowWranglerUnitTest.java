...
public class ShadowWranglerUnitTest {
    ...
    public void whenChildShadowHasNarrowerSdk_createShadowFor_shouldReturnSuperShadowSometimes() throws Exception {
        ...
        assertThat(new ShadowWrangler(shadowMap, 18, interceptors).createShadowFor(new ChildOfDummyClass())).isSameAs(ShadowWrangler.NO_SHADOW);
        ...
        assertThat(new ShadowWrangler(shadowMap, 22, interceptors).createShadowFor(new ChildOfDummyClass())).isSameAs(ShadowWrangler.NO_SHADOW);
    }
