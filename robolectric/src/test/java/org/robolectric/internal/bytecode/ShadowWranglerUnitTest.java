...
public class ShadowWranglerUnitTest {
    ...
    public void shadowClassWithSdkRange() throws Throwable {
        ...
        assertThat(new ShadowWrangler(shadowMap, 19, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.methodWithoutRange()");
    ...
    public void shadowMethodWithSdkRange() throws Throwable {
        ...
        assertThat(new ShadowWrangler(shadowMap, 20, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.methodFor20()");
    ...
    public void shadowMethodWithMinSdk() throws Throwable {
        ...
        assertThat(new ShadowWrangler(shadowMap, 19, interceptors).methodInvoked(methodName, false, DummyClass.class)).isNull();
        assertThat(new ShadowWrangler(shadowMap, 20, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.methodMin20()");
        assertThat(new ShadowWrangler(shadowMap, 21, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.methodMin20()");
    }
    ...
    public void shadowMethodWithMaxSdk() throws Throwable {
        ...
        assertThat(new ShadowWrangler(shadowMap, 19, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.methodMax20()");
        assertThat(new ShadowWrangler(shadowMap, 20, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.methodMax20()");
        assertThat(new ShadowWrangler(shadowMap, 21, interceptors).methodInvoked(methodName, false, DummyClass.class)).isNull();
    }
    ...
    public void shadowConstructor() throws Throwable {
        ...
        assertThat(new ShadowWrangler(shadowMap, 19, interceptors).methodInvoked(methodName, false, DummyClass.class)).isNull();
        assertThat(new ShadowWrangler(shadowMap, 20, interceptors).methodInvoked(methodName, false, DummyClass.class).describe()).contains("ShadowDummyClass.__constructor__()");
        assertThat(new ShadowWrangler(shadowMap, 21, interceptors).methodInvoked(methodName, false, DummyClass.class)).isNull();
    }
    ...
    public void whenChildShadowHasNarrowerSdk_createShadowFor_shouldReturnSuperShadowSometimes() throws Exception {
        ...
        assertThat(new ShadowWrangler(shadowMap, 18, interceptors).createShadowFor(new ChildOfDummyClass())).isSameInstanceAs(ShadowWrangler.NO_SHADOW);
        assertThat(new ShadowWrangler(shadowMap, 19, interceptors).createShadowFor(new ChildOfDummyClass())).isInstanceOf(ShadowDummyClass.class);
        assertThat(new ShadowWrangler(shadowMap, 20, interceptors).createShadowFor(new ChildOfDummyClass())).isInstanceOf(ShadowChildOfDummyClass.class);
        assertThat(new ShadowWrangler(shadowMap, 21, interceptors).createShadowFor(new ChildOfDummyClass())).isInstanceOf(ShadowChildOfDummyClass.class);
        assertThat(new ShadowWrangler(shadowMap, 22, interceptors).createShadowFor(new ChildOfDummyClass())).isSameInstanceAs(ShadowWrangler.NO_SHADOW);
    }
    ...
    public void whenChildShadowHasNarrowerSdk_shouldCallAppropriateShadowMethod() throws Exception {
        ...
        assertThat(new ShadowWrangler(shadowMap, 19, interceptors).methodInvoked(methodName, false, ChildOfDummyClass.class)).isNull();
        assertThat(new ShadowWrangler(shadowMap, 20, interceptors).methodInvoked(methodName, false, ChildOfDummyClass.class).describe()).contains("ShadowChildOfDummyClass.methodWithoutRange()");
        assertThat(new ShadowWrangler(shadowMap, 21, interceptors).methodInvoked(methodName, false, ChildOfDummyClass.class).describe()).contains("ShadowChildOfDummyClass.methodWithoutRange()");
    }
