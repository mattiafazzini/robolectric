...
public class ShadowingTest {
    ...
    public static class ShadowClassWithProtectedMethod {
        ...
        protected String getName() {
            System.out.println("ShadowClassWithProtectedMethod#getName");
            return "shadow name";
        }
    }
    ...
    public static class ShadowPaintForTests {
        ...
        protected void setColor(int color) {
            System.out.println("ShadowPaintForTests#setColor");
            this.color = color;
        }

        @Implementation
        protected int getColor() {
            System.out.println("ShadowPaintForTests#getColor");
            return color;
        }
    }
    ...
    public static class ShadowForClassWithNoDefaultConstructor {
        ...
        protected void __constructor__() {
            System.out.println("ShadowForClassWithNoDefaultConstructor#__constructor__");
    ...
    public static class ShadowNonInstrumentedClass {
        ...
        protected int plus(int x) {
            System.out.println("ShadowNonInstrumentedClass#plus");
            return x + 2;
        }
    }
